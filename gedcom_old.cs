...
namespace GEDCOM
{
    public static class GEDCOMClass
    {
            ...
            )
        {
            ...
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_TITL, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " SEX")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_SEX, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            ...
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_RELI, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " NAMR")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_NAMR, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
                while (Extraire_niveau(ligne) > niveau)
                {
                    ...
                    {
                        (info_INDIVIDUAL_53.N1_NAMR_RELI, ligne, ligne_perdue_liste) =
                            Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
                    ...
                    else
                    {
                        ...
                        groupe_ligne.Add(a1);
                        Ecrire_balise( method, lineNumber, groupe_ligne);
                        groupe_ligne.Clear();
                    }
                }
            }
            ...
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_EDUC, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " OCCU")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_OCCU, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " SSN")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_SSN, ligne, ligne_perdue_liste) = 
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " IDNO")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_IDNO, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
                while (Extraire_niveau(ligne) > niveau)
                {
                    string balise_1 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                    ...
                    {
                        (info_INDIVIDUAL_53.N1_IDNO_TYPE, ligne, ligne_perdue_liste) =
                            Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
                    }
                    else
                    {
            ...
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_PROP, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " DSCR")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_DSCR, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " SIGN")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_SIGN, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " NMR")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_NMR, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " NCHI")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_NCHI, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " NATI")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_NATI, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            else if (balise_0 == niveau.ToString() + " CAST")
            {
                trouver = true;
                (info_INDIVIDUAL_53.N0_CAST, ligne, ligne_perdue_liste) =
                    Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
            }
            /*else
            {
            ...
            )
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                {
                    (info.N1_PLAC, ligne, ligne_perdue_liste) =
                        Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " STAT")
                {
                    (info.N1_STAT, ligne, ligne_perdue_liste) =
                        Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        {
                            (info.N2_STAT_DATE, ligne, ligne_perdue_liste) =
                                Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
                        }
                        else
                        {
            ...
            )
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                if (balise_1 == (niveau + 1).ToString() + " TYPE")
                {
                    (info.N1_TYPE, ligne, ligne_perdue_liste) =
                        Extraire_texte_niveau_plus(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " DATE")
                {
            ...
            )
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                {
                    (info_LINK.FILE, ligne, ligne_perdue_liste) = 
                        Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        {
                            (info_LINK.FORM, ligne, ligne_perdue_liste) =
                                Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            while (Extraire_niveau(ligne) > niveau + 2)
                            {
                                ...
                                {
                                    (info_LINK.MEDI, ligne, ligne_perdue_liste) =
                                        Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                }
                                else
                                {
                                    (ligne_perdue_liste, ligne) = Ligne_perdu_plus(
                                        ligne,
                                        ligne_perdue_liste,
                ...
                {
                    info_LINK.ID_seul = false;
                    (info_LINK.TITL, ligne, ligne_perdue_liste) =
                        Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " NOTE")
                {
            ...
            )
        {
            ...
            try
            {
                while (Extraire_niveau(ligne) > 0)
                {
                    ...
                    {
                        case "1 FORM":                                                                    // FORM v5.
                            (N1_FORM, ligne, ligne_perdue_liste) =
                                Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 TITL":                                                                    // TITL v5.5
                            (N1_TITL, ligne, ligne_perdue_liste) =
                                Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break; ;
                        case "1 FILE":
                            (N1_FILE, ligne, ligne_perdue_liste) =
                                Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            while (Extraire_niveau(ligne) > 1)
                            {
                                ...
                                {
                                    case "2 FORM":
                                        (N2_FILE_FORM, ligne, ligne_perdue_liste) =
                                            Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                        while (Extraire_niveau(ligne) > 2)
                                        {
                                            ...
                                            {
                                                case "3 TYPE":
                                                    (N3_FILE_FORM_TYPE, ligne, ligne_perdue_liste) =
                                                        Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                                    break;
                                                default:
                                                    (ligne_perdue_liste, ligne) = Ligne_perdu_plus(
                                        ...
                                        break;
                                    case "2 TITL":
                                        (N2_FILE_TITL, ligne, ligne_perdue_liste) =
                                            Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                        break;
                                    default:
                                        (ligne_perdue_liste, ligne) = Ligne_perdu_plus(
                        ...
                        case "1 REFN":                                                                    // REFN
                            ...
                            break;
                        case "1 RIN":                                                                     // RIN
                            (N1_RIN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 NOTE":                                                                    // NOTE
                            string IDNote;
                            (IDNote, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        ...
                        case "1 DATE":                                                                    // _DATE Heridis
                            (N1__DATE, ligne, ligne_perdue_liste) =
                                Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        default:
                            (ligne_perdue_liste, ligne) = Ligne_perdu_plus(
            ...
            if (Extraire_niveau(ligne) > 0)
            {
                while (Extraire_niveau(ligne) > 0)
                {
                    try
                    {
                        ...
                        {
                            case "1 CLAS":                                                                // CLAS
                                (N1_CLAS, ligne, ligne_perdue_liste) =
                                    Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 PERI":                                                                // PERI V5.3
                                (N1_PERI, ligne, ligne_perdue_liste) =
                                    Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 SOUR":                                                                // SOUR V5.3
                                ...
                                break;
                            case "1 PAGE":                                                                // PAGE
                                (N1_PAGE, ligne, ligne_perdue_liste) =
                                    Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            ...
                            case "1 EMIG":
                                ...
                                break;
                            case "1 STAT":                                                                // STAT
                                (N1_STAT, ligne, ligne_perdue_liste) =
                                    Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                while (Extraire_niveau(ligne) > 1)
                                {
                                    string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                                    ...
                                    {
                                        case "2 DATE":                                                    // DATE
                                            (N2_STAT_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                            break;
                                        default:
                                            (ligne_perdue_liste, ligne) = Ligne_perdu_plus(
                                                ligne,
                            ...
                            case "1 REFS":                                                                // REFS
                                ...
                                {
                                    string refs;
                                    (refs, ligne, ligne_perdue_liste) =
                                        Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                    N1_REFS_liste_EVEN.Add(refs);
                                }
                                break;
                            case "1 FIDE":                                                                // FIDE
                                (N1_FIDE, ligne, ligne_perdue_liste) =
                                    Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 DATA":                                                                // DATA
                                ligne++;
                                    ...
                                    switch (balise_2)
                                    {
                                        case "2 EVEN":                                                    // DATA_EVEN  BIRT, DEAT, MARR.
                                            ...
                                            while (Extraire_niveau(ligne) > 2)
                                            {
                                                ...
                                                {
                                                    case "3 DATE":                                           // DATE
                                                        (N3_DATA_EVEN_DATE, ligne, ligne_perdue_liste) =
                                                            Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                                        break;
                                                    case "3 PLAC":                                            // PLAC
                                                        (N3_DATA_EVEN_PLAC, ligne, ligne_perdue_liste) =
                                                            Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                                        break;
                                                    default:
                                                        (ligne_perdue_liste, ligne) = Ligne_perdu_plus(
                                            ...
                                            break;
                                        case "2 AGNC":                                                    // AGNC
                                            (N2_DATA_AGNC, ligne, ligne_perdue_liste)
                                                = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                            break;
                                        case "2 NOTE":                                                    // NOTE
                                            string temp2;
                            ...
                            case "1 DATE":                                                                // DATE Herisis
                                (N1_DATE, ligne, ligne_perdue_liste) =
                                    Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 TITL":                                                               // TITL
                                string temp3 = null;
                                (temp3, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                N1_TITL_liste.Add(temp3);
                                break;
                            case "1 AUTH":                                                                // 1 AUTH
                                (N1_AUTH, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 TEXT":                                                               // TEXT
                                TEXT_STRUCTURE temp;
                            ...
                            case "1 REFN":                                                                // REFN
                                ...
                                break;
                            case "1 ABBR":                                                                // ABBR
                                (N1_ABBR, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 OBJE":                                                                // OBJE
                                string ID_OBJE;
                            ...
                            case "1 AUDIO":                                                               // AUDIO V5.3
                                string audio;
                                (audio, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                MULTIMEDIA_LINK_liste_ID.Add(audio);
                                break;
                            case "1 PHOTO":                                                               // PHOTO V5.3
                                string photo;
                                (photo, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                MULTIMEDIA_LINK_liste_ID.Add(photo);
                                break;
                            case "1 VIDEO":                                                               // VIDEO V5.3
                                string video;
                                (video, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            ...
                            case "1 EVEN":                                                                // 1 EVEN dans ancestrologie
                                (N1_EVEN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 QUAY":                                                                // 1 QUAY Heridis
                                (N1_QUAY, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 CPLR":
                                (N1_CPLR, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 EDTR":
                                (N1_EDTR, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                break;
                            case "1 TYPE":                                                                // 1 TYPE Heridis
                                (N1_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            )
        {
            ...
            (info_nom.N0_NAME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                if (balise_1 == (niveau + 1).ToString() + " TYPE")
                {
                    (info_nom.N1_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                ...
                {
                    (N1_nom_name_pieces.Nn_NPFX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " GIVN")
                {
                    (N1_nom_name_pieces.Nn_GIVN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " NICK")
                {
                    (N1_nom_name_pieces.Nn_NICK, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " SPFX")
                {
                    (N1_nom_name_pieces.Nn_SPFX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " SURN")
                {
                    (N1_nom_name_pieces.Nn_SURN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " NSFX")
                {
                    (N1_nom_name_pieces.Nn_NSFX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " NOTE")
                {
                    string IDNote;
                ...
                {
                    (info_nom.N1_FONE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        {
                            (info_nom.N2_FONE_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " NPFX")
                        {
                            (N1_FONE_name_pieces.Nn_NPFX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " GIVN")
                        {
                            (N1_FONE_name_pieces.Nn_GIVN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " NICK")
                        {
                            (N1_FONE_name_pieces.Nn_NICK, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " SPFX")
                        {
                            (N1_FONE_name_pieces.Nn_SPFX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " SURN")
                        {
                            (N1_FONE_name_pieces.Nn_SURN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " NSFX")
                        {
                            (N1_FONE_name_pieces.Nn_NSFX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                ...
                {
                    (info_nom.N1_ROMN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    ...
                    while (Extraire_niveau(ligne) > 2)
                    {
                        ...
                        if (balise_2 == (niveau + 2).ToString() + " TYPE")
                        {
                            (info_nom.N2_ROMN_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " NPFX")
                        {
                            (N1_ROMN_name_pieces.Nn_NPFX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " GIVN")
                        {
                            (N1_ROMN_name_pieces.Nn_GIVN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " NICK")
                        {
                            (N1_ROMN_name_pieces.Nn_NICK, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " SPFX")
                        {
                            (N1_ROMN_name_pieces.Nn_SPFX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " SURN")
                        {
                            (N1_ROMN_name_pieces.Nn_SURN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " NSFX")
                        {
                            (N1_ROMN_name_pieces.Nn_NSFX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else if (balise_2 == (niveau + 2).ToString() + " NOTE")
                        {
                            string temp2;
                ...
                {
                    string alia;
                    (alia, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            )
        {
            ...
            (info.N0_PLAC, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                {
                    (info.N1_CEME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                        int balise_2_ligne = ligne;
                        ...
                        {
                            (info.N2_CEME_PLOT, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else
                        {
                                // pour la page HTML
                ...
                {
                    (info.N1_FORM, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1) + " SITE")
                {
                    (info.N1_SITE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                ...
                {
                    (info.N1_FONE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                        int balise_2_ligne = ligne;
                        if (balise_2 == (niveau + 2).ToString() + " TYPE")
                        {
                            (info.N2_FONE_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else
                        {
                            // pour la page HTML
                ...
                {
                    (info.N1_ROMN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                        int balise_2_ligne = ligne;
                        if (balise_2 == (niveau + 2).ToString() + " TYPE")
                        {
                            (info.N2_ROMN_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else
                        {
                            // pour la page HTML
                ...
                else if (balise_1 == (niveau + 1) + " MAP")
                {
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        {
                            (info.N2_MAP_LATI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        ...
                        {
                            (info.N2_MAP_LONG, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
        ...
        private static int Extraire_REPOSITORY_RECORD(int ligne)
        {
            ...
            try
            {
                while ((Extraire_niveau(ligne) > niveau))
                {
                    ...
                    {
                        case "1 NAME":                                                                    // NAME
                            (N1_NAME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 CNTC":                                                                    // CNTC V5.3
                            (N1_CNTC, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 SITE":                                                                    // SITE V5.3
                            (N1_SITE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 ADDR":                                                                    // ADDR
                            ADDRESS_STRUCTURE N1_ADDR;
                            (N1_ADDR, ligne, ligne_perdue_liste) = Extraire_ADDRESS_STRUCTURE(ligne, ligne_perdue_liste);
                        ...
                        case "1 PHON":                                                                     // PHON
                            string phon;
                            (phon, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_PHON_liste.Add(phon);
                            break;
                        case "1 EMAIL":                                                                   // EMAIL
                            string email;
                            (email, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_EMAIL_liste.Add(email);
                            break;
                        case "1 _EMAIL":                                                                  // _EMAIL
                            string email2;
                            (email2, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_EMAIL_liste.Add(email2);
                            break;
                        case "1 FAX":                                                                     // FAX
                            string fax;
                            (fax, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_FAX_liste.Add(fax);
                            break;
                        case "1 WWW":                                                                     // www
                            string www;
                            (www, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_WWW_liste.Add(www);
                            break;
                        case "1 _WWW":                                                                    // _www
                            string www2;
                            (www2, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_WWW_liste.Add(www2);
                            break;
                        case "1 _URL":                                                                    // URL
                            string url;
                            (url, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_WWW_liste.Add(url);
                            ligne++;
                            break;
                        case "1 MEDI":                                                                    // MEDI V5.3
                            (N1_MEDI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 CALN":                                                                    // CALN V5.3
                            (N1_CALN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            while (Extraire_niveau(ligne) > niveau + 1)
                            {
                                string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                                int balise_2_ligne = ligne;
                                switch (balise_2)
                                {
                                    case "2 ITEM":                                                        // CALN ITEM V5.3
                                        (N2_CALN_ITEM, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                        break;
                                    case "2 SHEE":                                                        // CALN SHEE V5.3
                                        (N2_CALN_SHEE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                        break;
                                    case "2 PAGE":                                                        // CALN PAGE V5.3
                                        (N2_CALN_PAGE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                        break;
                                    default:
                                        // pour la page HTML
                                        Ligne_perdue bb = new Ligne_perdue()
            ...
            List<Ligne_perdue> ligne_perdue_liste)
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                {
                    (info_CENS.N1_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " LINE")
                {
                    (info_CENS.N1_LINE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " DWEL")
                {
                    (info_CENS.N1_DWEL, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " FAMN")
                {
                    (info_CENS.N1_FAMN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " NOTE")
                {
                    string IDNote;
            ...
            List<Ligne_perdue> ligne_perdue_liste)
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                {
                    (info_IMMI.N1_NAME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        if (balise_2 == (niveau + 2).ToString() + " ARVL")
                        {
                            ...
                            while (Extraire_niveau(ligne) > niveau + 2)
                            {
                                ...
                                {
                                    (info_IMMI.N3_PORT_ARVL_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                }
                                else if (balise_3 == (niveau + 3).ToString() + " PLAC")
                                {
                                    (info_IMMI.N3_PORT_ARVL_PLAC, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                }
                                else
                                {
                                    // pour la page HTML
                        ...
                        {
                            {
                                ...
                                while (Extraire_niveau(ligne) > niveau + 2)
                                {
                                    ...
                                    if (balise_3 == (niveau + 3).ToString() + " DATE")
                                    {
                                        (info_IMMI.N3_PORT_DPRT_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                    }
                                    else if (balise_3 == (niveau + 3).ToString() + " PLAC")
                                    {
                                        (info_IMMI.N3_PORT_DPRT_PLAC, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                    }
                                    else
                                    {
                                        // pour la page HTML
            ...
            )
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                if (balise_1 == (niveau + 1).ToString() + " NAME")
                {
                    (info_ORIG.N1_NAME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " TYPE")
                {
                    (info_ORIG.N1_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " NOTE")
                {
                    string IDNote;
            ...
            List<Ligne_perdue> ligne_perdue_liste)
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                if (balise_1 == (niveau + 1).ToString() + " NAME")
                {
                    (info_PUBL.N1_NAME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " TYPE")
                {
                    (info_PUBL.N1_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " PUBR")
                {
                    (info_PUBL.N1_PUBR, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " SITE")
                {
                    (info_PUBL.N1_SITE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                ...
                {
                    (info_PUBL.N1_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " EDTN")
                {
                    (info_PUBL.N1_EDTN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " SERS")
                {
                    (info_PUBL.N1_SERS, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " ISSU")
                {
                    (info_PUBL.N1_ISSU, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " LCCN")
                {
                    (info_PUBL.N1_LCCN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else
                {
                    // pour la page HTML
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    (info.N0_texte, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else
                    ligne++;
                Regler_code_erreur();
                ...
                while (Extraire_niveau(ligne) > niveau)
                {
                    ...
                    {
                        source_ID_seulement = false;
                        (info.N1_CLAS, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " PERI")
                    {
                        source_ID_seulement = false;
                        (info.N1_PERI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " TITL")
                    {
                        source_ID_seulement = false;
                    ...
                    {
                        source_ID_seulement = false;
                        (info.N1_PAGE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " DATE")
                    {
                        source_ID_seulement = false;
                        (info.N1_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    ...
                    else if (balise_1 == (niveau + 1).ToString() + " DATA")
                    {
                        ...
                        while (Extraire_niveau(ligne) > niveau + 1)
                        {
                            ...
                            if (balise_2 == (niveau + 2).ToString() + " DATE")
                            {
                                (info.N2_DATA_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                    ...
                    {
                        source_ID_seulement = false;
                        (info.N1_EVEN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        while (Extraire_niveau(ligne) > niveau + 1)
                        {
                            string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                            int balise_2_ligne = ligne;
                            ...
                            {
                                (info.N2_EVEN_ROLE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else
                            {
                                // pour la page HTML
                    ...
                    {
                        source_ID_seulement = false;
                        (info.N1_STAT, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        while (Extraire_niveau(ligne) > niveau + 1)
                        {
                            string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                            int balise_2_ligne = ligne;
                            if (balise_2 == (niveau + 2).ToString() + " DATE")
                            {
                                (info.N2_STAT_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else
                            {
                                // pour la page HTML
                    ...
                    else if (balise_1 == (niveau + 1).ToString() + " REFS")
                    {
                        ...
                        {
                            string refs;
                            (refs, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_REFS_liste_EVEN.Add(refs);
                        }
                    }
                    ...
                    {
                        source_ID_seulement = false;
                        (info.N1_FIDE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " QUAY")
                    {
                        source_ID_seulement = false;
                        (info.N1_QUAY, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " _QUAL") // _QUAL Heridis
                    {
                        ...
                        while (Extraire_niveau(ligne) > niveau + 1)
                        {
                            ...
                            {
                                (info.N2__QUAL__SOUR, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else if (balise_2 == (niveau + 2).ToString() + " INFO")
                            {
                                (info.N2__QUAL__INFO, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else if (balise_2 == (niveau + 2).ToString() + " _EVID")
                            {
                                (info.N2__QUAL__EVID, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else
                            {
                                // pour la page HTML
        ...
        {
            R.Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + " code " + callerLineNumber + "</b><br>ligne_code=" + ligne_code);
            Regler_code_erreur();
            ...
            )
        {
            ...
            int lineNumber;
            string n0_name;
            (n0_name, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                if (balise_1 == (niveau + 1).ToString() + " TYPE")
                {
                    (info_NAME_STRUCTURE_53.N1_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " SOUR")
                {
                    string citation;
            ...
            )
        {
            ...
            try
            {
                while (Extraire_niveau(ligne) > 0)
                {
                    ...
                    if (balise_1 == "1 DEST")
                    {
                        (info_HEADER.N1_DEST, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == "1 SOUR")
                    {
                        string balise_1_texte;
                        (balise_1_texte, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        ...
                        while (Extraire_niveau(ligne) > 1)
                        {
                            ...
                            if (balise_2 == "2 VERS")
                            {
                                (info_HEADER.N2_SOUR_VERS, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else if (balise_2 == "2 NAME")
                            {
                                (info_HEADER.N2_SOUR_NAME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else if (balise_2 == "2 CORP")
                            {
                                (info_HEADER.N2_SOUR_CORP, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                while (Extraire_niveau(ligne) > 2)
                                {
                                    string balise_3 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                                    int balise_3_ligne = ligne;
                                    if (balise_3 == "3 SITE")
                                    {
                                        (info_HEADER.N3_SOUR_CORP_SITE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                    }
                            ...
                            {
                                (info_HEADER.N2_SOUR_DATA, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                while (Extraire_niveau(ligne) > 2)
                                {
                                    string balise_3 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                                    int balise_3_ligne = ligne;
                                    if (balise_3 == "3 DATE")
                                    {
                                        (info_HEADER.N3_SOUR_DATA_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                    }
                                    else if (balise_3 == "3 CORP")
                                    {
                                        (info_HEADER.N3_SOUR_DATA_CORP, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                    }
                                    else
                                    {
                                        // pour la page HTML
                    ...
                    {
                        (info_HEADER.N1_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        while (Extraire_niveau(ligne) > 1)
                        {
                            string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                            int balise_2_ligne = ligne;
                            if (balise_2 == "2 TIME")
                            {
                                (info_HEADER.N2_DATE_TIME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else
                            {
                                // pour la page HTML
                    ...
                    {
                        (info_HEADER.N1_FILE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == "1 SUBN")
                    {
                        (info_HEADER.N1_SUBN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    ...
                    else if (balise_1 == "1 GEDC")
                    {
                        ...
                        while (Extraire_niveau(ligne) > 1)
                        {
                            ...
                            if (balise_2 == "2 VERS")
                            {
                                (info_HEADER.N2_GEDC_VERS, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else if (balise_2 == "2 FORM")
                            {
                                (info_HEADER.N2_GEDC_FORM, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                while (Extraire_niveau(ligne) > 2)
                                {
                                    string balise_3 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                                    int balise_3_ligne = ligne;
                                    if (balise_3 == "3 VERS")
                                    {
                                        (info_HEADER.N3_GEDC_FORM_VERS, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                    }
                                    else
                                    {
                                        // pour la page HTML
                    ...
                    {
                        (info_HEADER.N1_CHAR, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        while (Extraire_niveau(ligne) > 1)
                        {
                            string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                            int balise_2_ligne = ligne;
                            if (balise_2 == "2 VERS")
                            {
                                (info_HEADER.N2_CHAR_VERS, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else
                            {
                                // pour la page HTML
                    ...
                    else if (balise_1 == "1 PLAC")
                    {
                        ...
                        while (Extraire_niveau(ligne) > 1)
                        {
                            ...
                            if (balise_2 == "2 FORM")
                            {
                                (info_HEADER.N2_PLAC_FORM, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            }
                            else
                            {
                                // pour la page HTML
                    ...
                    {
                        (info_HEADER.N1_LANG, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == "1 COPR")
                    {
                        (info_HEADER.N1_COPR, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    ...
                    {
                        (info_HEADER.N1__GUID, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else
                    {
                        // pour la page HTML
            ...
            )
        {
            ...
            {
                (info.N0_ADDR, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                while (Extraire_niveau(ligne) > niveau)
                {
                    string balise_1 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                    int balise_1_ligne = ligne;
                    ...
                    {
                        (info.N1_ADR1, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    ...
                    {
                        (info.N1_ADR2, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " ADR3")
                    {
                        (info.N1_ADR3, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " CITY")
                    {
                        (info.N1_CITY, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " STAE")
                    {
                        (info.N1_STAE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " CTRY")
                    {
                        (info.N1_CTRY, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " POST")
                    {
                        (info.N1_POST, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    }
                    else if (balise_1 == (niveau + 1).ToString() + " PHON")
                    {
                        (temp, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            )
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                {
                    (N1_RELA, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                }
                else if (balise_1 == (niveau + 1).ToString() + " TYPE")
                {
                    (N1_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            )
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                if (balise_1 == (niveau + 1).ToString() + " DATE")
                {
                    (N1_CHAN_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    while (Extraire_niveau(ligne) > niveau + 1) // > +1
                    {
                        ...
                        {
                            (N2_CHAN_DATE_TIME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else
                        {
                            // pour la page HTML
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                if (balise_1 == (niveau + 1).ToString() + "ADOP")
                {
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        int balise_2_ligne = ligne;
                        if (balise_2 == (niveau + 2).ToString() + " TYPE")
                            (info.N2_ADOP_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else if (balise_2 == (niveau + 2).ToString() + " AGE")
                            (info.N2_ADOP_AGE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else if (balise_2 == (niveau + 2).ToString() + " DATE")
                            (info.N2_ADOP_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                ...
                else if (balise_1 == (niveau + 1).ToString() + " SLGC")
                {
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        int balise_2_ligne = ligne;
                        if (balise_2 == (niveau + 2).ToString() + " TYPE")
                            (info.N2_SLGC_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else if (balise_2 == (niveau + 2).ToString() + " DATE")
                            (info.N2_SLGC_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else if (balise_2 == (niveau + 2).ToString() + " TEMP")
                            (info.N2_SLGC_TEMP, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else
                        {
                            // pour la page HTML
                            Ligne_perdue aa = new Ligne_perdue()
                    ...
                    (info.N1_PEDI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " STAT")
                    (info.N1_STAT, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " NOTE")
                {
            ...
            )
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                {
                    string type;
                    (type, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    N2_TYPE_liste.Add(type);
                }
                else if (balise_1 == (niveau + 1).ToString() + " DATE")
                {
                    (info.N2_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        {
                            (info.N3_DATE_TIME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        }
                        else
                        {
                            // pour la page HTML
                    ...
                    (info.N2_TEMP, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " PLAC")
                {
                    ...
                    (info.N2_SITE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " ADDR")
                {
                ...
                else if (balise_1 == (niveau + 1).ToString() + " WWW" || balise_1 == (niveau + 1).ToString() + " _WWW" || balise_1 == (niveau + 1).ToString() + "_URL")
                {
                    ...
                    (info.N2_QUAY, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " AGNC")
                    (info.N2_AGNC, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " RELI")
                    (info.N2_RELI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " CAUS")
                    (info.N2_CAUS, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " RESN")
                    (info.N2_RESN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " NOTE")
                {
                    string IDNote;
                    (IDNote, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                ...
                else if (balise_1 == (niveau + 1).ToString() + " SOUR")
                {
                    ...
                    (info.N2_AGE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " MSTAT")
                    (info.N2_MSTAT, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " FAMC")
                {
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        if (balise_2 == (niveau + 2).ToString() + " ADOP")
                            (info.N2_FAMC_ADOP, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else
                        {
                            // pour la page HTML
                            Ligne_perdue bb = new Ligne_perdue()
                ...
                else if (balise_1 == (niveau + 1).ToString() + " HUSB")
                {
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        if (balise_2 == (niveau + 2).ToString() + " AGE")
                            (info.N3_HUSB_AGE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else
                        {
                            // pour la page HTML
                            Ligne_perdue cc = new Ligne_perdue()
                ...
                else if (balise_1 == (niveau + 1).ToString() + " WIFE")
                {
                    ...
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        ...
                        int balise_2_ligne = ligne;
                        if(balise_2 == (niveau + 2).ToString() + " AGE")
                            (info.N3_WIFE_AGE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else
                        {
                            // pour la page HTML
                            Ligne_perdue cc = new Ligne_perdue()
                    ...
                    (info.N2__ANCES_ORDRE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    ...
                    (info.N2__ANCES_XINSEE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1).ToString() + " _FNA")
                {
                    (info.N2__FNA, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        int balise_2_ligne = ligne;
                        // pour la page HTML
                    ...
                    switch (balise_1)
                    {
                        ...
                        case "1 DIVF":
                            ...
                            while (Extraire_niveau(ligne) > 1)
                            {
                                ...
                                {
                                    case "2 TYPE":                                                        // TYPE
                                        (N2_EVEN_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                        break;
                                    case "2 DATE":                                                        // DATE
                                        (N2_EVEN_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                    ...
                                    case "2 PLAC":                                                        // PLAC
                                        ...
                                        break;
                                    case "2 PERI":                                                        // PERI
                                        (N2_EVEN_PERI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                        break;
                                    case "2 RELI":                                                        // RELI
                                        (N2_EVEN_RELI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                        break;
                                    case "2 AUDIO":                                                       // AUDIO individu V5.3
                                        //(temp, ligne) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                        ...
                                        while (Extraire_niveau(ligne) > 2)
                                        {
                                            ...
                                            switch (balise_3)
                                            {
                                                ...
                                                case "3 TYPE":                                                    // EVEN ROLE TYPE
                                                    (N3_EVEN_ROLE_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                                    break;
                                                    ...
                                                    while (Extraire_niveau(ligne) > 3)
                                                    {
                                                        ...
                                                        switch (balise_4)
                                                        {
                                                            ...
                                                            Extraire_INDIVIDUAL_53(
                                                                ...
                                                                break;
                                                            case "4 TYPE":                                // TYPE
                                                                (N4_EVEN_ROLE_RELATIONSHIP_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                                                break;
                                                            default:
                                                                {
        ...
        private static (EVEN_STRUCTURE_53, int) Extraire_EVEN_STRUCTURE_53(int ligne, int niveau)
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                if (balise_1 == (niveau + 1) + " TYPE")
                    (info_EVEN_STRUCTURE_53.N1_TYPE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " DATE")
                    (info_EVEN_STRUCTURE_53.N1_DATE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    ...
                    (info_EVEN_STRUCTURE_53.N1_AGE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " MSTAT")
                    (info_EVEN_STRUCTURE_53.N1_MSTAT, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " CAUS")
                    (info_EVEN_STRUCTURE_53.N1_CAUS, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " RELI")
                    (info_EVEN_STRUCTURE_53.N1_RELI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " AGNC")
                    (info_EVEN_STRUCTURE_53.N1_AGNC, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                ...
                while (Extraire_niveau(ligne) > niveau)
                {
                    ...
                    switch (balise_1)
                    {
                        ...
                        case "1 ASSO":                                                                    //1 ASSO V5.3
                            ...
                            break;
                        case "1 RESN":                                                                    //1 RESN
                            (N1_RESN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 TYPU":                                                                    // 1 TYPU pour Ancestrologie
                            (N1_TYPU, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 _UST":                                                                    // 1 _UST Heridis
                            (N1__UST, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 HUSB":                                                                    // 1 HUSB
                        ...
                        case "1 CHIL":                                                                    // 1 CHIL
                            ...
                            break;
                        case "1 NCHI":                                                                    // 1 NCHI
                            (N1_NCHI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 SUBM":                                                                    // 1 SUBM
                            if (dataGEDCOM[ligne].Length > 7)
                            {
                ...
                while (Extraire_niveau(ligne) > niveau)
                {
                    ...
                    switch (balise_1)
                    {
                        ...
                        case "1 NAMR":                                                                    // 1 NAMR V5.3
                            (N1_NAMR, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            while (Extraire_niveau(ligne) > niveau + 1)
                            {
                                if (Avoir_balise_p1(dataGEDCOM[ligne].ToUpper()) == "2 RELI")               // 1 NAMR RELI V5.3
                                {
                                    (N2_NAMR_RELI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                                }
                                else
                                {
                                    // pour la page HTML
                        ...
                        case "1 FILA":// Ancestrologie
                            (N1_FILA, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 SEX":
                            (N1_SEX, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        ...
                        case "1 DESI":                                                                    // DESI
                            ...
                            break;
                        case "1 RFN":                                                                     // RFN
                            (N1_RFN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 AFN":                                                                     // AFN
                            (N1_AFN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        ...
                        case "1 AUDIO":                                                                   // AUDIO individu V5.3
                            ...
                            (fichier_audio, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        ...
                        case "1 PHOTO":                                                                   // PHOTO individu  V5.3
                            ...
                            (fichier_photo, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        ...
                        case "1 VIDEO":                                                                   // VIDEO individu V5.3
                            ...
                            (fichier_video, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        ...
                        case "1 _ANCES_CLE_FIXE":                                                         // _ANCES_CLE_FIXE
                            (N1__ANCES_CLE_FIXE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 PHON":                                                                    // PHON
                            string temp_phon = null;
                            (temp_phon, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_PHON_liste.Add(temp_phon);
                            break;
                        case "1 EMAIL":                                                                   // EMAIL
                            string temp_email = null;
                            (temp_email, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_EMAIL_liste.Add(temp_email);
                            break;
                        case "1 FAX":                                                                     // FAX
                            string temp_fax = null;
                            (temp_fax, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_FAX_liste.Add(temp_fax);
                            break;
                        case "1 WWW":                                                                     // WWW
                            string temp_www = null;
                            (temp_www, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_WWW_liste.Add(temp_www);
                            break;
                        case "1 SIGN":                                                                    // SIGN
                            (N1_SIGN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_SIGN = N1_SIGN.ToUpper();
                            break;
                        case "1 _FIL":                                                                    // _FIL pour Heresis
                            (N1__FIL, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            if (IsNotNullOrEmpty(N1__FIL)) N1__FIL = N1__FIL.ToUpper();
                            break;
                        case "1 _CLS":                                                                    // CLS pour Heresis
                            (N1__CLS, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            )
        {
            ...
            // DEBUG
            R.Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + " code " + "<br>N0_ID_RECORD=" + N0_ID_RECORD + "<br>N0_ID_STRUCTURE=" + N0_ID_STRUCTURE + "<br>N0_texte= " + N0_texte + "<br>ligne=" + ligne);
            List<string> N1_SOUR_citation_liste_ID = new List<string>();
            List<string> N1_SOUR_source_liste_ID = new List<string>();
            List<string> N1_NOTE_STRUCTURE_liste_ID = new List<string>();
            int[] balise_ligne = new int[10];
            ...
            List<Ligne_perdue> ligne_perdue_liste)
        {
            ...
            while (Extraire_niveau(ligne) > niveau)
            {
                ...
                if (balise_1 == (niveau + 1) + " NAME")
                    (info.N1_NAME, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " CNTC")
                    (info.N1_CNTC, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " SITE")
                    (info.N1_SITE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " ADDR")
                {
                ...
                else if (balise_1 == (niveau + 1) + " WWW" || balise_1 == (niveau + 1) + " _WWW" || balise_1 == (niveau + 1) + " _URL")
                {
                    ...
                    (info.N1_MEDI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " CALN")
                {
                    (info.N1_CALN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                    while (Extraire_niveau(ligne) > niveau + 1)
                    {
                        string balise_2 = Avoir_niveau_balise(dataGEDCOM[ligne]);
                        int balise_2_ligne = ligne;
                        if (balise_2 == (niveau + 2).ToString() + " ITEM")
                            (info.N2_CALN_ITEM, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else if (balise_2 == (niveau + 2).ToString() + " SHEE")
                            (info.N2_CALN_SHEE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else if (balise_2 == (niveau + 2).ToString() + " PAGE")
                            (info.N2_CALN_PAGE, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else if (balise_2 == (niveau + 2).ToString() + " MEDI")
                            (info.N2_CALN_MEDI, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        else
                        {
                            // pour la page HTML
                            Ligne_perdue aa = new Ligne_perdue()
                    ...
                    (info.N1_REFN, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                else if (balise_1 == (niveau + 1) + " NOTE")
                {
                    string IDNote;
                    (IDNote, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            try
            {
                while (Extraire_niveau(ligne) > 0)
                {
                    ...
                    switch (balise_1)
                    {
                        ...
                        case "1 PHON":                                                                    // PHON
                            string a;
                            (a, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_PHON_liste.Add(a);
                            break;
                        case "1 FAX":                                                                     // FAX
                            string b;
                            (b, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_FAX_liste.Add(b);
                            break;
                        case "1 EMAIL":                                                                   // EMAIL
                            string c;
                            (c, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_EMAIL_liste.Add(c);
                            break;
                        case "1 _EMAIL":                                                                  // _EMAIL
                            string d;
                            (d, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_EMAIL_liste.Add(d);
                            break;
                        case "1 WWW":                                                                     // WWW
                            string e;
                            (e, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_WWW_liste.Add(e);
                            break;
                        case "1 _WWW":                                                                    // _WWW
                            string f;
                            (f, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_WWW_liste.Add(f);
                            break;
                        case "1 _URL":                                                                    // _URL 
                            string g;
                            (g, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            N1_WWW_liste.Add(g);
                            break;
                        case "1 LANG":                                                                    // LANG
                            (N1_LANG, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                            break;
                        case "1 NOTE":                                                                    // NOTE
                            string IDNote;
                            (IDNote, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
                        ...
                        case "1 VIDEO":                                                                   // VIDEO V5.3
                            string fichier;
                            string temp_link;
                            (fichier, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            ...
            List<Ligne_perdue> ligne_perdue_liste)
        {
            ...
            List<string> N1_NOTE_STRUCTURE_liste_ID = new List<string>();
            int niveau = Extraire_niveau(ligne);
            (info_texte.N0_TEXT, ligne, ligne_perdue_liste) = Extraire_NOTE_STRUCTURE(ligne, ligne_perdue_liste);
            int balise_0_ligne = ligne;
            //ligne++;
            while (Extraire_niveau(ligne) > niveau)
            {
            ...
            )
        {
            ...
            Regler_code_erreur();
            while ( balise == (niveau ).ToString() + " CONT" || balise == (niveau ).ToString() + " CONC" || balise == null) 
            {
                Regler_code_erreur();
                ...
                R.Z("balise=" + balise);
                Regler_code_erreur();
                R.Z(ligne + " " + dataGEDCOM[ligne] + " " + " texte=" + texte);
            }
            Regler_code_erreur();
        ...
        private static (List<Ligne_perdue>, int ) Ligne_perdu_plus(
            int ligne,
            List<Ligne_perdue> ligne_perdue_liste,
            ...
            )
        {
            ...
            groupe_ligne.Clear();
            ligne++;
            return (ligne_perdue_liste,ligne);
        }
