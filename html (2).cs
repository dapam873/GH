...
namespace HTML
{
    public class HTMLClass
    {
        ...
        private static string Avoir_lien_chercheur(List<string> liste_chercheur_ID, List<ID_numero> liste_chercheur_ID_numero, int tab)
        {
            ...
            //liste_chercheur_ID_numero = Verifier_liste(liste_chercheur_ID, liste_chercheur_ID_numero);
            string espace = Tabulation(tab);
            string texte = "";
            Separation("mince", tab);
            texte += espace + "<span style=\"font-Size:11px;font-weight:normal;\">\n";
            if (liste_chercheur_ID_numero != null)
            {
                int compteur_chercheur;
                if (liste_chercheur_ID.Count == 1)
                {
                    texte += espace + "\tVoir le chercheur ";
                }
                else
                {
                    texte += espace + "\tVoir les chercheurs ";
                }
        ...
        private static string Avoir_lien_citation_source(List<string> liste_citation_ID, List<ID_numero> liste_citation_ID_numero, int tab)
        {
            ...
            string espace = Tabulation(tab);
            string texte = "";
            //liste_citation_ID_numero = Verifier_liste(liste_citation_ID, liste_citation_ID_numero);
            Separation("mince", 6);
        ...
        /*private static List<ID_numero> Ajouter_citation_de_note(List<ID_numero> liste_note_ID_numero, List<ID_numero> liste)
        {
            foreach (ID_numero note_ID in liste_note_ID_numero)
            {
                GEDCOMClass.NOTE_RECORD info_note = GEDCOMClass.Avoir_Info_Note(note_ID.ID);
                if (info_note != null)
                {
                    if (info_note.N1_SOUR_citation_liste_ID != null)
                    {
                        liste = Verifier_liste(info_note.N1_SOUR_citation_liste_ID, liste);
                    }
                }
            }
            return liste;
        }*/
        /*private static List<ID_numero> Ajouter_note_de_citation(List<ID_numero> liste_citation_ID_numero, List<ID_numero> liste)
        {

            foreach (ID_numero citation_ID in liste_citation_ID_numero)
            {
                GEDCOMClass.SOURCE_CITATION info_citation = GEDCOMClass.Avoir_info_citation(citation_ID.ID);
                if (info_citation != null)
                {
                    if (info_citation.N1_NOTE_liste_ID != null)
                    {
                        liste = Verifier_liste(info_citation.N1_NOTE_liste_ID, liste);
                    }
                }
            }
            return liste;
        ...
        /*private static List<ID_numero> Ajouter_note_de_depot(List<ID_numero> liste_depot_ID_numero, List<ID_numero> liste)
        {
            foreach (ID_numero depot_ID in liste_depot_ID_numero)
            {
                GEDCOMClass.REPOSITORY_RECORD info_depot = GEDCOMClass.Avoir_Info_Repo(depot_ID.ID);
                if (info_depot.N1_NOTE_liste_ID != null)
                {
                    liste = Verifier_liste(info_depot.N1_NOTE_liste_ID, liste);
                }
            }
            return liste;
        }*/
        /*private static List<ID_numero> Ajouter_note_de_note_dans_changement_date(List<ID_numero> liste)
        {
            for(int f = 0; f < liste.Count; f++)
            {
                GEDCOMClass.NOTE_RECORD info_note = GEDCOMClass.Avoir_Info_Note(liste[f].ID);
                if (info_note.N1_CHAN != null)
                {
                    if (info_note.N1_CHAN.N1_CHAN_NOTE_ID_liste != null)
                    {
                        liste = Verifier_liste(info_note.N1_CHAN.N1_CHAN_NOTE_ID_liste, liste);
                    }
                }
            }
            return liste;
        }*/
        /*private static List<ID_numero> Ajouter_note_de_source(List<ID_numero> liste_source_ID_numero, List<ID_numero> liste)
        {
            foreach (ID_numero source_ID in liste_source_ID_numero)
            {
                GEDCOMClass.SOURCE_RECORD info_source = GEDCOMClass.Avoir_info_SOURCE(source_ID.ID);
                if (info_source.N1_NOTE_liste_ID != null)
                {
                    liste = Verifier_liste(info_source.N1_NOTE_liste_ID, liste);
                }
            }
            return liste;
        }*/
        ...
        /*private static List<ID_numero> Avoir_liste_citation_famille(string ID_famille, List<ID_numero> liste_citation)
        {

            // avoir info famielle
            GEDCOMClass.FAM_RECORD info_famille;
            info_famille = GEDCOMClass.Avoir_info_famille(ID_famille);
            // citation de l'individu
            if (info_famille.N1_SOUR_citation_liste_ID != null)
                liste_citation = Verifier_liste(info_famille.N1_SOUR_citation_liste_ID, liste_citation);
            // SLGS
            if (info_famille.N1_SLGS.N1_SOUR_citation_liste_ID != null)
                liste_citation = Verifier_liste(info_famille.N1_SLGS.N1_SOUR_citation_liste_ID, liste_citation);
            return liste_citation;
        }*/
        /*private static List<ID_numero> Avoir_liste_citation_individu(string ID_individu, List<ID_numero> liste_citation)
        {
            // avoir info individu
            GEDCOMClass.INDIVIDUAL_RECORD infoIndividu;
            (_, infoIndividu) = GEDCOMClass.Avoir_info_individu(ID_individu);
            // citation de l'individu
            if (infoIndividu.N1_SOUR_citation_liste_ID != null)
                liste_citation = Verifier_liste(infoIndividu.N1_SOUR_citation_liste_ID, liste_citation);
            // citation sur les noms
            List<GEDCOMClass.PERSONAL_NAME_STRUCTURE> listeInfoNom;
            (_, listeInfoNom) = GEDCOMClass.AvoirListeNom(ID_individu);
            // nom
            if (listeInfoNom != null) foreach (GEDCOM.GEDCOMClass.PERSONAL_NAME_STRUCTURE infoNom in listeInfoNom)
                {
                    // nom ordinaire
                    if (infoNom.N1_SOUR_citation_liste_ID != null)
                    {
                        liste_citation = Verifier_liste(infoNom.N1_SOUR_citation_liste_ID, liste_citation);
                    }
                    // nom FONE
                    if (infoNom.N2_FONE_SOUR_citation_liste_ID != null)
                    {
                        liste_citation = Verifier_liste(infoNom.N2_FONE_SOUR_citation_liste_ID, liste_citation);
                    }
                    // nom romanitiser
                    if (infoNom.N2_ROMN_SOUR_citation_liste_ID != null)
                    {
                        liste_citation = Verifier_liste(infoNom.N2_ROMN_SOUR_citation_liste_ID, liste_citation);
                    }
                }
            ...
            if (infoIndividu.N1_ASSO_liste != null)
            {
                foreach (GEDCOMClass.ASSOCIATION_STRUCTURE info_ASSO in infoIndividu.N1_ASSO_liste)
                {
                    ...
                    {
                        liste_citation = Verifier_liste(info_ASSO.N1_SOUR_citation_liste_ID, liste_citation);
                    }
                }
            }
            // citatione media
            ...
            {
                foreach (string media_ID in infoIndividu.N1_OBJE_liste)
                {
                    // citation media
                    GEDCOMClass.MULTIMEDIA_RECORD mediaInfo = GEDCOMClass.AvoirMedia(media_ID);
                        liste_citation = Verifier_liste(mediaInfo.N1_SOUR_citation_liste_ID, liste_citation);
                }
            }
            // citation Ordonnance
            if (infoIndividu.N1_LDS_liste != null)
                foreach (GEDCOMClass.LDS_INDIVIDUAL_ORDINANCE info_LDS in infoIndividu.N1_LDS_liste)
                    liste_citation = Verifier_liste(info_LDS.N1_SOUR_citation_liste_ID, liste_citation);

            //citation evenement
            foreach (GEDCOMClass.EVENT_ATTRIBUTE_STRUCTURE info in infoIndividu.N1_EVENT_Liste)
            {
                if (info.N2_SOUR_citation_liste_ID != null)
                    liste_citation = Verifier_liste(info.N2_SOUR_citation_liste_ID, liste_citation);
                // citation PLAC
                if (info.N2_PLAC != null)
                {

                    liste_citation = Verifier_liste(info.N2_PLAC.N1_SOUR_citation_liste_ID, liste_citation);
                }
            }
            return liste_citation;
        }*/
            ...
            List<ID_numero> liste_repo_ID_numero)
        {
            ...
            if (GH.Properties.Settings.Default.voir_media)
            {
                if (info_individu.N1_OBJE_liste != null && info_individu.N1_OBJE_liste != null)
                {
                    foreach (string IDMedia in info_individu.N1_OBJE_liste)
                    {
                        GEDCOMClass.MULTIMEDIA_RECORD info_media = GEDCOMClass.AvoirMedia(IDMedia);
                        if (info_media != null)
                        {
                            // note du media
            ...
            {
                foreach (GEDCOMClass.EVENT_ATTRIBUTE_STRUCTURE info_evenement in info_individu.N1_Attribute_liste)
                {
                    // citation attribut
                    (liste_citation_ID_numero, _) = Verifier_liste(info_evenement.N2_SOUR_citation_liste_ID, liste_citation_ID_numero);
                    // if PLAC n'est pas null
            ...
            // loop pour note citation source depot
            if (GH.Properties.Settings.Default.voir_reference || liste_citation_ID_numero != null)
            {
                ...
                do
                {
                    ...
                    if (liste_source_ID_numero != null)
                    {
                        ...
                        {
                            GEDCOMClass.SOURCE_RECORD info_source = GEDCOMClass.Avoir_info_SOURCE(liste_ID_numero.ID);
                            // dépôt
                    ...
                    {
                        GEDCOMClass.NOTE_RECORD info_note = GEDCOMClass.Avoir_Info_Note(liste_ID_numero.ID);
        ...
        /*private static List<ID_numero> Avoir_liste_repo(List<ID_numero> liste_source_ID_numero, List<ID_numero> liste)
        {
            foreach (ID_numero source_ID in liste_source_ID_numero)
            {
                GEDCOMClass.SOURCE_RECORD info_source = GEDCOMClass.Avoir_info_SOURCE(source_ID.ID);
                if (info_source.N1_REPO_info != null)
                {
                    // mettre le ID dans une liste pour la fonction Reviser
                    List<string> temp = new List<string>
                    {
                        info_source.N1_REPO_info.N0_ID
                    };
                    liste = Verifier_liste(temp, liste);
                }
            }
            return liste;
        }*/
        /*private static List<ID_numero> Avoir_liste_note_famille(string ID_famille, List<ID_numero> liste_note)
        {
            // avoir info famille
            GEDCOMClass.FAM_RECORD info_famille;
            info_famille = GEDCOMClass.Avoir_info_famille(ID_famille);
            // note famille
            if (info_famille.N1_NOTE_liste_ID != null)
                liste_note = Verifier_liste(info_famille.N1_NOTE_liste_ID, liste_note);
            // SLGS
            if (info_famille.N1_SLGS.N1_NOTE_liste_ID != null)
                liste_note = Verifier_liste(info_famille.N1_SLGS.N1_NOTE_liste_ID, liste_note);
            return liste_note;
        }*/
        /*private static List<ID_numero> Avoir_liste_note_individu(string ID_individu, List<ID_numero> liste_note)
        {
            // avoir info individu
            GEDCOMClass.INDIVIDUAL_RECORD infoIndividu;
            (_, infoIndividu) = GEDCOMClass.Avoir_info_individu(ID_individu);
            ...
            if (listeInfoNom != null) foreach (GEDCOM.GEDCOMClass.PERSONAL_NAME_STRUCTURE infoNom in listeInfoNom)
                {
                    ...
                    {
                        liste_note = Verifier_liste(infoNom.N1_NOTE_liste_ID, liste_note);
                    }
                    // nom FONE
                    if (infoNom.N2_FONE_NOTE_ID_liste != null)
                    {
                        liste_note = Verifier_liste(infoNom.N2_FONE_NOTE_ID_liste, liste_note);
                    }
                    // nom romanitiser
                    if (infoNom.N2_ROMN_NOTE_ID_liste != null)
                    {
                        liste_note = Verifier_liste(infoNom.N2_ROMN_NOTE_ID_liste, liste_note);
                    }
                }
            // si association
            if (infoIndividu.N1_ASSO_liste != null)
            {
                foreach (GEDCOMClass.ASSOCIATION_STRUCTURE info_ASSO in infoIndividu.N1_ASSO_liste)
                {
                    ...
                    {
                        liste_note = Verifier_liste(info_ASSO.N1_NOTE_liste_ID, liste_note);
                    }
                }
            }
            // note individu
            ...
            {
                liste_note = Verifier_liste(infoIndividu.N1_NOTE_liste_ID, liste_note);
            }
            // conjoint
            foreach (GEDCOMClass.SPOUSE_TO_FAMILY_LINK infoLienConjoint in infoIndividu.N1_FAMS_liste_Conjoint)
            {
                liste_note = Verifier_liste(infoLienConjoint.N1_NOTE_liste_ID, liste_note);
            }
            // note parent
            GEDCOMClass.CHILD_TO_FAMILY_LINK infoFamille = GEDCOMClass.AvoirInfoFamilleEnfant(ID_individu);
            if (infoFamille.N1_NOTE_liste_ID != null)
            {
                liste_note = Verifier_liste(infoFamille.N1_NOTE_liste_ID, liste_note);
            }
            // note media
            if (infoIndividu.N1_OBJE_liste != null)
            {
                foreach (string IDMedia in infoIndividu.N1_OBJE_liste)
                {
                    ...
                    foreach (string N1_NOTE_liste_ID in mediaInfo.N1_NOTE_liste_ID)
                    {
                        liste_note = Verifier_liste(mediaInfo.N1_NOTE_liste_ID, liste_note);
                    }
                }
            }
            // note Ordonnance
            if (infoIndividu.N1_LDS_liste != null)
            foreach (GEDCOMClass.LDS_INDIVIDUAL_ORDINANCE info_LDS in infoIndividu.N1_LDS_liste)
                if (info_LDS.N1_NOTE_liste_ID != null)
                    liste_note = Verifier_liste(info_LDS.N1_NOTE_liste_ID, liste_note);
            // note evenement
            foreach (GEDCOMClass.EVENT_ATTRIBUTE_STRUCTURE info in infoIndividu.N1_EVENT_Liste)
            {
                // note PLAC
                if (info.N2_PLAC != null)
                {
                    if (info.N2_PLAC.N1_NOTE_liste_ID != null)
                        liste_note = Verifier_liste(info.N2_PLAC.N1_NOTE_liste_ID, liste_note);
                }
                // note adresse pour GRAMPS
                if (info.N2_ADDR != null)
                {
                    if (info.N2_ADDR.N1_NOTE_liste_ID != null)
                        liste_note = Verifier_liste(info.N2_ADDR.N1_NOTE_liste_ID, liste_note);
                }
                // note evenement
                if (info.N2_NOTE_liste_ID != null)
                    liste_note = Verifier_liste(info.N2_NOTE_liste_ID, liste_note);
            }
            // note attribut
            foreach (GEDCOMClass.EVENT_ATTRIBUTE_STRUCTURE info in infoIndividu.N1_Attribute_liste)
            {
                if(info.N2_NOTE_liste_ID != null)
                    liste_note = Verifier_liste(info.N2_NOTE_liste_ID, liste_note);
            }
            // note chercheur
                foreach (string  SUBM_ID in infoIndividu.N1_SUBM_liste_ID)
            {
                GEDCOMClass.SUBMITTER_RECORD info = GEDCOMClass.Avoir_info_chercheur(SUBM_ID);
                // node de l'adresse
                GEDCOMClass.ADDRESS_STRUCTURE InfoAdresse = info.N1_ADDR;
                if (InfoAdresse.N1_NOTE_liste_ID != null)
                    liste_note = Verifier_liste(InfoAdresse.N1_NOTE_liste_ID, liste_note);
                // note chercheur
                if (info.N1_NOTE_liste_ID != null)
                    liste_note = Verifier_liste(info.N1_NOTE_liste_ID, liste_note);
            }
            // note ANCI
            foreach (string ANCI_ID in infoIndividu.N1_ANCI_liste_ID)
            {
                GEDCOMClass.SUBMITTER_RECORD info = GEDCOMClass.Avoir_info_chercheur(ANCI_ID);
                if (info.N1_NOTE_liste_ID != null)
                {
                    liste_note = Verifier_liste(info.N1_NOTE_liste_ID, liste_note);
                }
            ...
            // note DESI
            foreach (string DESI_ID in infoIndividu.N1_DESI_liste_ID)
            {
                GEDCOMClass.SUBMITTER_RECORD info = GEDCOMClass.Avoir_info_chercheur(DESI_ID);
                if (info.N1_NOTE_liste_ID != null) liste_note = Verifier_liste(info.N1_NOTE_liste_ID, liste_note);
            }
            // note de CHAN
            if (infoIndividu.N1_CHAN.N1_CHAN_NOTE_ID_liste != null)
            {
                liste_note = Verifier_liste(infoIndividu.N1_CHAN.N1_CHAN_NOTE_ID_liste, liste_note);
            }
            return liste_note;
        }*/
/*        private static List<ID_numero> Avoir_liste_source(List<ID_numero> liste_citation_ID_numero, List<ID_numero> liste)
        {
            foreach (ID_numero citation_ID in liste_citation_ID_numero)
            {
                GEDCOMClass.SOURCE_CITATION info_citation = GEDCOMClass.Avoir_info_citation(citation_ID.ID);
        ...
        /*private static List<ID_numero> Avoir_liste_submitter_individu(string ID_individu, List<ID_numero> liste)
        {
            GEDCOMClass.INDIVIDUAL_RECORD info_individu;
            (_, info_individu) = GEDCOMClass.Avoir_info_individu(ID_individu);
            // individu
            if (info_individu.N1_SUBM_liste_ID != null)
            {
                foreach (string N1_SUBM_liste_ID in info_individu.N1_SUBM_liste_ID)
                    liste = Verifier_liste(info_individu.N1_SUBM_liste_ID, liste);
            }
            // ANCI
            if (info_individu.N1_ANCI_liste_ID != null)
                liste = Verifier_liste(info_individu.N1_ANCI_liste_ID, liste);
            // DESI
            if (info_individu.N1_DESI_liste_ID != null)
            {
                liste = Verifier_liste(info_individu.N1_DESI_liste_ID, liste);
            }
            return liste;
        }*/
        /*private static List<ID_numero> Avoir_liste_submitter_famille(string ID_famille, List<ID_numero> liste)
        {
            GEDCOMClass.FAM_RECORD info_famille;
            info_famille = GEDCOMClass.Avoir_info_famille(ID_famille);
            // famille
            if (info_famille.N1_SUBM_liste_ID != null)
            {
                foreach (string N1_SUBM_liste_ID in info_famille.N1_SUBM_liste_ID)
                    liste = Verifier_liste(info_famille.N1_SUBM_liste_ID, liste);
            }
            return liste;
        }*/
        ...
        private static (string, List<ID_numero>) Avoir_lien_repo(string ID_repo, List<ID_numero> liste_repo_ID_numero, int tab)
        {
            ...
            /*List<string> liste_repo_ID = new List<string>
            {
                ID_repo
            };*/
            //liste_repo_ID_numero = Verifier_liste(liste_repo_ID, liste_repo_ID_numero);
            string espace = Tabulation(tab);
            ...
            bool multi_ligne = false)
        {
                ...
                )
            {
                ...
                if (multi_ligne && info.N1_CHAN_NOTE_ID_liste != null) texte += espace + "\t<br/>\n";
        ...
        public void Famille(string IDFamille, bool menu, string dossierSortie)
        {
            ...
            /*
            liste_SUBMITTER_ID_numero = Avoir_liste_submitter_famille(IDFamille, liste_SUBMITTER_ID_numero);
            liste_note_ID_numero = Avoir_liste_note_famille(IDFamille, liste_note_ID_numero);
            liste_citation_ID_numero = Avoir_liste_citation_famille(IDFamille, liste_citation_ID_numero);
            liste_source_ID_numero = Avoir_liste_source(liste_citation_ID_numero, liste_source_ID_numero);
            liste_repo_ID_numero = Avoir_liste_repo(liste_source_ID_numero, liste_repo_ID_numero);
            liste_note_ID_numero = Ajouter_note_de_citation(liste_citation_ID_numero, liste_note_ID_numero);
            liste_note_ID_numero = Ajouter_note_de_source(liste_source_ID_numero, liste_note_ID_numero);
            liste_note_ID_numero = Ajouter_note_de_depot(liste_repo_ID_numero, liste_note_ID_numero);*/
            //liste_note_ID_numero = Ajouter_note_de_note_dans_chagement_date(liste_note_ID_numero);
            temp_liste.Clear();
            string temp;
            ...
            texte += "\t\t\t\t\t<td>\n";
            texte += "\t\t\t\t\t\tFamille\n";
            temp = Avoir_lien_citation_source(infoFamille.N1_SOUR_citation_liste_ID, liste_citation_ID_numero, 6);
            texte += temp;
            if (GH.Properties.Settings.Default.VoirID == true)
            {
            ...
            temp_liste = liste_note_ID_numero;
            temp_liste.Clear();
            temp_liste = liste_citation_ID_numero;
            temp_liste.Clear();
            temp_liste = liste_source_ID_numero;
            temp_liste.Clear();
            temp_liste = liste_repo_ID_numero;
            temp_liste.Clear();
            //@menu hamburger
        ...
        public void Index(string fichierGEDCOM, string nombreIndividu, string nombreFamille, string dossierSortie)
        {
            ...
            //Reviser_liste(InfoGEDCOM.N1_NOTE_liste_ID, liste_note_ID_numero);
        ...
        public string Individu(string IDIndividu, bool menu, string dossierSortie)
        {
            ...
            List<ID_numero> liste_repo_ID_numero = new List<ID_numero>();
            //List<ID_numero> temp_liste = new List<ID_numero>();
            /*liste_SUBMITTER_ID_numero = Avoir_liste_submitter_individu(IDIndividu, liste_SUBMITTER_ID_numero);
            liste_note_ID_numero = Avoir_liste_note_individu(IDIndividu, liste_note_ID_numero);
            liste_citation_ID_numero = Avoir_liste_citation_individu(IDIndividu, liste_citation_ID_numero);
            liste_source_ID_numero = Avoir_liste_source(liste_citation_ID_numero, liste_source_ID_numero);



            liste_repo_ID_numero = Avoir_liste_repo(liste_source_ID_numero, liste_repo_ID_numero);
            liste_citation_ID_numero = Ajouter_citation_de_note(liste_note_ID_numero, liste_citation_ID_numero);
            liste_note_ID_numero = Ajouter_note_de_citation(liste_citation_ID_numero, liste_note_ID_numero);
            liste_note_ID_numero = Ajouter_note_de_source(liste_source_ID_numero, liste_note_ID_numero);
            liste_note_ID_numero = Ajouter_note_de_depot(liste_repo_ID_numero, liste_note_ID_numero);
            liste_note_ID_numero = Ajouter_note_de_note_dans_changement_date(liste_note_ID_numero);
            */
            (
                liste_SUBMITTER_ID_numero,
                liste_note_ID_numero,
                ...
                GEDCOM.GEDCOMClass.SOURCE_RECORD info_source = GEDCOMClass.Avoir_info_SOURCE(item_source.ID);
                {
                    ...
                    texte += espace + "\t\t</tr>\n";
                    {
                        ...
                        if (info_source.N1_REPO_info != null)
                        {
                            ...
                            // note du dépôt
                            if (info_source.N1_REPO_info.N1_NOTE_liste_ID != null)
                            {
                                texte += espace + "\t\t<tr>\n";
                                texte += espace + "\t\t\t<td style=\"width:150px\">\n";
                                texte += espace + "\t\t\t\t\t&nbsp;wwww\n";
        ...
        private (string, bool) Groupe_chercheur(
            ...
            int tab)
        {
            if(GH.Properties.Settings.Default.voir_chercheur == false || liste == null)
                return ("", false);
            string espace = Tabulation(tab);
            string texte = "";
            texte += Separation("large", tab);
