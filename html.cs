...
namespace HTML
{
    public class HTMLClass
    {
            ...
            )
        {
            ...
            {
                R.Afficher_message(
                    "Erreur dans la routine " + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + ".",
                    msg.Message,
                    GH.GHClass.erreur,
                    null,
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (GEDCOMClass.PERSONAL_NAME_STRUCTURE infoNom in liste_info_nom)
                {
                    ...
                    if (infoNom.N1_MIDDLE != null)
                    {
                        texte += espace + "\t<div class=\"tableau_ligne\">\n";
                        texte += espace + "\t\t<div class=\"tableau_col1\">\n";
                        texte += espace + "\t\t\tDeuxième prénom\n";
                        texte += espace + "\t\t</div>\n";
                        texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                        texte += espace + "\t\t\t" + infoNom.N1_MIDDLE + "\n";
                        texte += espace + "\t\t</div>\n";
                        texte += espace + "\t</div>\n";
                    }
                    if (infoNom.N1_LAST2 != null)
                    {
                        texte += espace + "\t<div class=\"tableau_ligne\">\n";
                        texte += espace + "\t\t<div class=\"tableau_col1\">\n";
                        texte += espace + "\t\t\tDernier nom\n";
                        texte += espace + "\t\t</div>\n";
                        texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                        texte += espace + "\t\t\t" + infoNom.N1_LAST2 + "\n";
                        texte += espace + "\t\t</div>\n";
                        texte += espace + "\t</div>\n";
                    }
                    texte += espace + "\t\t</div>\n";
        ...
        */
            ...
            )
        {
            ...
            try
            {
                if (!GH.GHClass.Para.voir_carte)
                    return "";
                string espace = Tabulation(tab);
                texte = espace + "<div id=\"map" + Numero_carte.ToString() + "\" class=\"carte\"></div>\n";
                texte += espace + "<script>\n";
            ...
            )
        {
            ...
            try
            {
                ...
                int tab = 3;
                // dossier
                nomFichierFamille = @dossier_sortie + "/familles/" + ID_famille + ".html";
                if (!menu)
...
//**************
            ...
            {
                R.Afficher_message(
                    "Ne peut pas écrire le fichier" + nomFichierFamille + ".",
                    msg.Message,
                    GH.GHClass.erreur,
                    null,
                    MessageBoxButtons.OK,
            ...
            )
        {
            ...
            try
            {
                ...
                nomFichier = @dossier_sortie + @"\index.html";
                string texte = null;
            ...
            {
                R.Afficher_message(
                    "Ne peut pas écrire le fichier" + nomFichier + ".",
                    msg.Message,
                    GH.GHClass.erreur,
                    null,
                    MessageBoxButtons.OK,
        ...
        {
            Regler_code_erreur();
            string FamilleConjointIndex = null;
            ListView lvChoixFamille = Application.OpenForms["GHClass"].Controls["lvChoixFamille"] as ListView;
            string nomFichier = null;
            string texte = null;
            try
            {
                ...
                nomFichier = @dossier_sortie + @"\familles\" + "indexConjoint.html";
                if (File.Exists(nomFichier))
                {
                    File.Delete(nomFichier);
                }
                FamilleConjointIndex = Texte_bouton_index_conjoint();
            ...
            for (int f = 0; f < 27; f++)
            {
                if (alphabette[f])
                {
                    ...
                    {
                        R.Afficher_message("Ne peut pas écrire le fichier" + dossier_sortie + ".",
                            msg.Message,
                            GH.GHClass.erreur,
                            null,
                            MessageBoxButtons.OK,
        ...
        {
            Regler_code_erreur();
            string FamilleConjointeIndex = null;
            ;
            ListView lvChoixFamille = Application.OpenForms["GHClass"].Controls["lvChoixFamille"] as ListView;
            string nomFichier = null;
            string texte;
            try
            {
                Application.DoEvents();
                string sous_dossier = "familles";
                nomFichier = @dossier_sortie + @"\familles\" + "indexConjointe.html";
                ...
                texte = null;
                FamilleConjointeIndex = Texte_bouton_index_conjointe();
            ...
            for (int f = 0; f < 27; f++)
            {
                if (alphabette[f])
                {
                    ...
                    {
                        R.Afficher_message(
                            "Ne peut pas écrire le fichier" + dossier_sortie + ".",
                            msg.Message,
                            GH.GHClass.erreur,
                            null,
                            MessageBoxButtons.OK,
        ...
        )
        {
            ...
            Regler_code_erreur();
            string nom = null;
            string nomFichierIndividu = null;
            try
            {
                int nombre_source = 0;
                ...
                nom = GEDCOMClass.Avoir_premier_nom_individu(ID_individu);
                info_nom_liste = GEDCOMClass.Avoir_liste_nom_individu(ID_individu);
                ...
                nomFichierIndividu = dossier_sortie + @"\individus\" + ID_individu + ".html";
                if (!menu)
            ...
            {
                R.Afficher_message(
                    "Ne peut pas écrire le fichier" + nomFichierIndividu + ".",
                    msg.Message,
                    GH.GHClass.erreur,
                    null,
                    MessageBoxButtons.OK,
