...
namespace HTML
{
    public class HTMLClass
    {
            ...
            int tab)
        {
            ...
            string texte = "";
            string temp;
            foreach (ListeSUBMITTER item in liste)
            {
        ...
        public void Famille(string IDFamille, bool menu, string dossierSortie)
        {
            ...
            List<ID_numero> liste_SUBMITTER = new List<ListeSUBMITTER>();
                ...
                )
            {
                ...
                if(infoFamille.N1_SUBM_liste_ID.Count > 0 && GH.Properties.Settings.Default.voir_chercheur)
                {
                    ...
                    foreach (string ID in infoFamille.N1_SUBM_liste_ID)
                    {
                        ...
                        {
                            numeroSUBMITTER = 1;
                            ListeSUBMITTER info_ANCI = new ListeSUBMITTER
                            {
                        ...
                        {
                            bool existe = false;
                            foreach (ListeSUBMITTER IDListe in liste_SUBMITTER)
                            {
                                if (ID == IDListe.ID)
                                {
                                    existe = true;
                ...
                if (InfoGEDCOM.N1_SUBM_liste_ID != null)
                {
                    ...
                    string texteTemp = "";
                    {
                        foreach (string ID in InfoGEDCOM.N1_SUBM_liste_ID)
                        {
                            ...
                            {
                                numero_chercheur = 1;
                                ListeSUBMITTER info = new ListeSUBMITTER
                                {
        ...
        public string Individu(string IDIndividu, bool menu, string dossierSortie)
        {
            ...
            (note_liste_ID_numero, citation_liste_ID_numero, source_liste_ID_numero, repo_liste_ID_numero) =
            ...
            List<ListeSUBMITTER> liste_SUBMITTER = new List<ListeSUBMITTER>();
            ...
            if (infoIndividu.N1_DESI_liste_ID.Count > 0)
            {
                ...
                foreach (string ID in infoIndividu.N1_DESI_liste_ID)
                {
                    ...
                    {
                        numeroSUBMITTER = 1;
                        ListeSUBMITTER info_DESI = new ListeSUBMITTER
                        {
                            numero = numeroSUBMITTER,
                            ID = ID
                        };
                        liste_SUBMITTER.Add(info_DESI);
                        texteTemp += "<a class=\"chercheur\" href=\"#RefSubmitter" + numeroSUBMITTER.ToString() + "\">" + numeroSUBMITTER.ToString() + "</a>" + ", ";
                        numeroSUBMITTER++;
                    }
                    else
