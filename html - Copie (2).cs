...
namespace HTML
{
    public class HTMLClass
    {
        ...
        private class MULTIMEDIA_ID_numero
        {
            ...
            public int numero; // numero assigné 
            //public int ID_LINK_doubler; // ID de LINK qui est sont double
        }

        public static string Avoir_texte_age_evenenemt(string age)
        {
            string texte = null;
            /*
            V5.3 p.
             ...
             */
            if (R.IsNullOrEmpty(age)) return null;
            age = age.ToLower();
            if (age == "child") return "moins de 8 ans";
            if (age == "infant") return "moins de 1 ans";
            if (age == "stillborn") return "Décédé juste avant, ou après la naissance, 0 ans";
            ...
            {
                if (section[f] == "y") section[f] = "ans";
                if (section[f] == "m") section[f] = "mois";
                if (section[f] == "d") section[f] = "jours";
            ...
            if (section[section.Count() - 1] == "jours") {
                ...
                if (jour == 1) section[section.Count()] = "jour";
            }
            for (int f = 0; f < section.Count(); f++)
            {
                texte += section[f] + " ";
        ...
        {
            //R..Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            if (!GH.GH.Para.voir_media || liste_ID == null || liste_MULTIMEDIA_ID_numero == null)
                return(
                    null,
            ...
            foreach (string ID in liste_ID)
            {
                ...
                if (info_LINK != null)
                    ...
                    {
                        texte += espace + "<div class=\"multimedia\"";
                        if (marge) texte += espace + "style=\" margin:3px;width:calc(100% - 10px);\"";
                        texte += espace +">\n";
                        texte += espace + "\t<div class=\"multimedia_flex_150\">\n";
                        ...
                        if (info_LINK.FILE != null)
                        {
                            ...
                            {
                                texte += espace + "\t<a class=\"media\" href=\"" + "medias/" + fichier +
                                        "\" target=\"_BLANK\">\n";
                                texte += espace + "\t\t<img class=\"mini_150\" src=\"" + origine +
                                        "commun/doc.svg\" alt=\"\" />\n";
                                texte += espace + "\t</a>\n";
                        ...
                        texte += espace + "\t<div class=\"multimedia_flex\">\n";    
                        // ID
                        if (GH.GH.Para.voir_ID)
                    {
                    ...
                    {
                        texte += espace + "\t<div style=\"text-align:left\">\n";
                        texte += espace + "\t\tFormat: " + info_LINK.FORM + "\n";
                        texte += espace + "\t</div>\n";
                    }
                    ...
                    // NOTE record
                    if (info_LINK.NOTE_STRUCTURE_liste_ID != null)
                    {
                        texte += Avoir_texte_NOTE_STRUCTURE(
                            info_LINK.NOTE_STRUCTURE_liste_ID,
                            liste_citation_ID_numero,
                ...
                if (info_RECORD != null)
                {
                    //Ra.Z("ID record=" + info_RECORD.ID_RECORD);
                    texte += espace + "<div class=\"multimedia\"";
                    if (marge) texte += espace + "style=\" margin:3px;width:calc(100% - 10px);\"";
                    texte += espace + ">\n";
                    texte += espace + "\t<div class=\"multimedia_flex_150\">\n";
                    ...
                    {
                        texte += espace + "\t<div style=\"text-align:left\">\n";
                        texte += espace + "\t\tFormat: " + info_RECORD.FORM + "\n";
                        texte += espace + "\t</div>\n";
                    }
                    ...
                    // RECORD DATE Heridis
                    (string date, _) = Convertir_date(info_RECORD.Herisis_DATE, GH.GH.Para.date_longue);
                    if (date != null)
                    {
                        texte += espace + "\t<div style=\"text-align:left\">\n";
                        texte += espace + "\t\t" + date + "\n";
            ...
            //foreach(ID_numero a in liste_citation_ID_numero) Ra.Z("liste_citation_ID_numero N=" + a.numero + " ID=" + a.ID);
            ...
            )
        {
            ...
            if (R.IsNullOrEmpty(liste)) return null;
            string espace = Tabulation(tab);
            string texte = null;
            string temp_string;
            foreach (ID_numero item in liste)
            {
                ...
                if (info_chercheur == null) return null;
                ...
                if (GH.GH.Para.voir_date_changement && info_chercheur.N1_CHAN != null)
                {
                ...
                texte += Avoir_texte_ligne_perdu(info_chercheur.ligne_perdue_liste, tab + 1);
                // fin tableau
                texte += espace + "</div>\n";
            }
            GC.Collect();
        ...
        {
            if (liste_ID == null) return (null, false);
            string origine = @"../";
            if (sous_dossier == "") origine = "";
            string texte = null;
            string espace = Tabulation(tab);
            if (GH.GH.Para.voir_media)
            {
            ...
            )
        {
            ...
            if (R.IsNotNullOrEmpty(liste)) titre += "s";
            // titre du groupe
            ...
            if (liste.Count > 1)
            {
                ...
                foreach (GEDCOMClass.EVEN_ATTRIBUTE_STRUCTURE info in liste)
                {
                    ...
                    texte += espace + "\t\t\t<td>\n";
                    string date;
                    (date, _) = Convertir_date(info.N2_DATE, GH.GH.Para.date_longue);
                    texte += espace + "\t\t\t\t\t" + date + "\n";
                    texte += espace + "\t\t\t</td>\n";
                    texte += espace + "\t\t\t<td>\n";
                    texte += espace + "\t\t\t\t" + Convertir_EVEN_en_texte(info.N2_DATE) + "\n";
                    texte += espace + "\t\t\t</td>\n";
                    texte += espace + "\t\t</tr>\n";
                }
                texte += espace + "\t</table>\n";
...
*/
            ...
            )
        {
            ...
            string origine = @"../";
            if (R.IsNullOrEmpty(sous_dossier)) origine = "";
            string texte = null;
            string espace = Tabulation(tab);
            ...
            if (R.IsNotNullOrEmpty(info.N0_SEX))
            {
                ...
                if (info.N0_SEX == "M")
                {
                    fichierSex = origine + "commun/male.svg";
                }
                else if (info.N0_SEX == "F")
                {
                    fichierSex = origine + "commun/femelle.svg";
                }
                else
                {
                    fichierSex = origine + "commun/neutre.svg";
                }
                texte += espace + "\t<div class=\"tableau_ligne\" style=\"margin-right:2px\">\n";
                texte += espace + "\t\t<div class=\"tableau_col1\">\n";
            ...
            // RELI
            if (R.IsNotNullOrEmpty(info.N0_RELI) && GH.GH.Para.religion)
            {
                texte += espace + "\t<div class=\"tableau_ligne\">\n";
                texte += espace + "\t\t<div class=\"tableau_col1\">\n";
            ...
            if (R.IsNotNullOrEmpty(info.N0_NAMR) && GH.GH.Para.religion)
            {
                texte += espace + "\t<div class=\"tableau_ligne\">\n";
                texte += espace + "\t\t<div class=\"tableau_col1\">\n";
            ...
            // Nom de la religion
            if (R.IsNotNullOrEmpty(info.N1_NAMR_RELI) && GH.GH.Para.religion)
            {
                texte += espace + "\t<div class=\"tableau_ligne\">\n";
                texte += espace + "\t\t<div class=\"tableau_col1\">\n";
                texte += espace + "\t\t\t&nbsp;\n";
            ...
            if (R.IsNotNullOrEmpty(info.N0_IDNO))
            {
                ...
                if (R.IsNotNullOrEmpty(info.N1_IDNO_TYPE))
                {
                    ...
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                    texte += espace + "\t\t\t" + info.N1_IDNO_TYPE + "\n";
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                }
            }
        ...
        {
            if (!GH.GH.Para.voir_reference) return "";
            Application.DoEvents();
            ...
            int tab = 0)
        {
            ...
            if (info_IMMI.N3_PORT_DPRT_DATE != null)
                (date, _) = Convertir_date(info_IMMI.N3_PORT_DPRT_DATE, GH.GH.Para.date_longue);
            texte += date + " à ";
            string lieu = "_ _ _ _ _ _ _ _ _ _ _ _ _";

            if (info_IMMI.N3_PORT_DPRT_PLAC != null) lieu = info_IMMI.N3_PORT_DPRT_PLAC;
            texte += lieu + ".\n";

            texte += espace + "\t\t\tArrivé le ";
            date = "_ _ _ _ _ _";
            if (info_IMMI.N3_PORT_ARVL_DATE != null)
                (date, _) = Convertir_date(info_IMMI.N3_PORT_ARVL_DATE, GH.GH.Para.date_longue);
            texte += date + " à ";
            lieu = "_ _ _ _ _ _ _ _ _ _ _ _ _";
            if (info_IMMI.N3_PORT_ARVL_PLAC != null) lieu = info_IMMI.N3_PORT_ARVL_PLAC;
            texte += lieu + ".\n";
            texte += espace + "\t\t</div>\n";
            texte += espace + "\t</div>\n";
            // texte
            ...
            )
        {
            ...
            //Ra.Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            //Ra.Z_liste_string(liste_citation_ID);
            //foreach (ID_numero a in liste_citation_ID_numero) Ra.Z("liste_citation_ID_numero N=" + a.numero + " ID=" + a.ID);
            string texte = null;
            if (!GH.GH.Para.voir_reference) return texte;
            if (R.IsNullOrEmpty(liste_citation_ID)) return texte;
            string espace = Tabulation(tab);
            ...
            foreach (string ID in liste_citation_ID)
            {
                ...
                if (compteur_citation == 0) texte += BLINK0 + "\n";
                else
            ...
            )
        {
            ...
            {
                // avoir date
                if (GH.GH.Para.tout_evenement)
                    texte_date = ToUpperFirst(Avoir_texte_date_priver(
                            info_evenement.N2_DATE,
                            GH.GH.Priver.naissance_date,
                            GH.GH.Priver.naissance_ans));
                else
                {
                    if (Si_religion(info_evenement.N1_EVEN) && !GH.GH.Para.religion)
                        return (
                            null,
                            numero_carte,
                            numero_source);
                    else if (!GH.GH.Para.citoyen && info_evenement.N1_EVEN == "NATU")
                        return (
                            null,
                            numero_carte,
                            numero_source);
                    else if (Si_testament(info_evenement.N1_EVEN) && !GH.GH.Para.testament)
                        return (
                            null,
                            numero_carte,
                            numero_source);
                    if (Si_religion(info_evenement.N1_EVEN) && GH.GH.Para.religion)
                        texte_date = ToUpperFirst(Avoir_texte_date_priver(
                            info_evenement.N2_DATE,
                            GH.GH.Priver.religion_date,
                            GH.GH.Priver.religion_ans));
                    else if (GH.GH.Para.citoyen && info_evenement.N1_EVEN == "NATU")
                        texte_date = ToUpperFirst(Avoir_texte_date_priver(
                            info_evenement.N2_DATE,
                            GH.GH.Priver.citoyen_date,
                            GH.GH.Priver.citoyen_ans));
                    else if (Si_testament(info_evenement.N1_EVEN) && !GH.GH.Para.testament)
                        texte_date = ToUpperFirst(Avoir_texte_date_priver(
                            info_evenement.N2_DATE,
                            GH.GH.Priver.testament_date,
                            GH.GH.Priver.testament_ans));
                }
                // Texte de EVEN
                if (R.IsNotNullOrEmpty(info_evenement.N1_EVEN_texte))
                {
                ...
                // Age individu
                if (info_evenement.N1_EVEN != "BIRT" && R.IsNotNullOrEmpty(info_evenement.N2_AGE))
                {
                    texte_bloque += espace + "\t<div class=\"tableau_ligne\">\n";
                    ...
                    else
                    {
                        ...
                        if (R.IsNotNullOrEmpty(age)) texte_bloque += espace + Avoir_texte_age_evenenemt(age);
                ...
                if (R.IsNotNullOrEmpty(info_evenement.N2_TYPE_liste))
                {
                    ...
                    foreach (string type in info_evenement.N2_TYPE_liste)
                    {
                        ...
                        if (numero_type < nombre_item) texte_bloque += "\t\t\t<br />";
                    }
                    texte_bloque += espace + "\t\t</div>\n";
                    texte_bloque += espace + "\t</div>\n";
                }
                ...
                {
                    if (GH.GH.Para.voir_date_changement && info_evenement.N2_CHAN != null)
                    {
                        texte_bloque += espace + "\t<div class=\"tableau_ligne\">\n";
                        texte_bloque += espace + "\t\t<div class=\"tableau_colW\">\n";
            ...
            if (texte_date != null) texte_titre += espace + texte_date + "\n";
            ...
            texte += Avoir_texte_ligne_perdu(info_evenement.ligne_perdue_liste, tab + 1);
            // fin tableau
            texte += espace + "</div>\n";
            GC.Collect();
            return (
            ...
            )
        {
            ...
            {
                if (Si_religion(info_evenement.N0_EVEN) && !GH.GH.Para.religion)
                    return (null, numero_carte, numero_source);
                else if (!GH.GH.Para.citoyen && info_evenement.N0_EVEN == "NATU")
                    return (null, numero_carte, numero_source);
                else if (Si_testament(info_evenement.N0_EVEN) && !GH.GH.Para.testament)
                    return (null, numero_carte, numero_source);
                ...
                {
                    texte_date = info_evenement.N1_DATE;
                }
            }
            // Description
            ...
            {
                if (GH.GH.Para.voir_date_changement && info_evenement.N1_CHAN != null)
                {
                    texte_bloque += espace + "\t<div class=\"tableau_ligne\">\n";
                    texte_bloque += espace + "\t\t<div class=\"tableau_colW\">\n";
                    texte_bloque += Avoir_texte_date_Changement(
            ...
            if (info_evenement.N0_EVEN != "BIRT")
            {
                ...
                else
                {
                    ...
                    if (R.IsNotNullOrEmpty(age)) texte_titre += espace + "\t\t\tà l'âge de " + age;
                }
            }
            texte_titre += espace + "\t\t</div>\n";
            texte_titre += espace + "\t</div>\n";
        ...
        {
            if (!GH.GH.Para.voir_date_changement || N1_CHAN == null)
                return (
                    liste_MULTIMEDIA_ID_numero,
                    liste_source_ID_numero,
                    liste_repo_ID_numero,
            ...
            if (GH.GH.Para.voir_reference)
            {
                ...
                foreach (ID_numero ID_numero in liste_repo_ID_numero)
                {
                    ...
                    if (info_repo != null)
                    {
                        if (GH.GH.Para.voir_date_changement && info_repo.N1_CHAN_liste != null)
                            foreach (GEDCOMClass.CHANGE_DATE info_date in info_repo.N1_CHAN_liste)
                            {
                                if (GH.GH.Para.voir_note)
                                {
                                    (liste_note_STRUCTURE_ID_numero, modifier) =
            ...
            )
        {
            ...
            foreach (ID_numero repo in liste_repo_ID_numero)
            {
                ...
                {
                    // Note
                    if (GH.GH.Para.voir_note && R.IsNotNullOrEmpty(info_repo.N1_NOTE_STRUCTURE_liste_ID))
                    {
                        (liste_note_STRUCTURE_ID_numero, modifier) =
                           Verifier_liste(info_repo.N1_NOTE_STRUCTURE_liste_ID, liste_note_STRUCTURE_ID_numero);
                    }
                    // CHAN
                    if (GH.GH.Para.voir_date_changement && R.IsNotNullOrEmpty(info_repo.N1_CHAN_liste))
                    {
                        foreach (GEDCOMClass.CHANGE_DATE info_date in info_repo.N1_CHAN_liste)
                        {
                            if (GH.GH.Para.voir_note && R.IsNotNullOrEmpty(info_date.N1_CHAN_NOTE_STRUCTURE_ID_liste))
                            {
                                (liste_note_STRUCTURE_ID_numero, modifier) =
                                    Verifier_liste(info_date.N1_CHAN_NOTE_STRUCTURE_ID_liste, liste_note_STRUCTURE_ID_numero);
                            }
        ...
        {
            //GEDCOMClass.ZXXCV("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            if (GH.GH.Para.voir_note && R.IsNullOrEmpty(liste_NOTE_RECORD_ID_numero))
                return (
                   liste_citation_ID_numero,
                   liste_source_ID_numero,
                   liste_repo_ID_numero,
            ...
            for (int f = 0; f < liste_NOTE_RECORD_ID_numero.Count; f++)
            {
                ...
                if (info_NOTE_RECORD != null)
                {
                    ...
                    if (modifier) boucler = true; if (modifier) boucler = true;
                    (liste_source_ID_numero, modifier) =
                        Verifier_liste(info_NOTE_RECORD.N1_SOUR_source_liste_ID, liste_source_ID_numero);
                    if (modifier) boucler = true;
                    // CHAN
                    if (GH.GH.Para.voir_date_changement && R.IsNotNullOrEmpty(info_NOTE_RECORD.N1_CHAN_liste))
                    {
        ...
        {
            //R..Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            if (!GH.GH.Para.voir_note && R.IsNullOrEmpty(liste_note_STRUCTURE_ID_numero))
            {
                return (
                    liste_citation_ID_numero,
                    liste_source_ID_numero,
        ...
        )
        {
            ...
            for (int f = 0; f < liste_source_ID_numero.Count; f++)
            {
                ...
                if (GEDCOMClass.Si_info_source(liste_source_ID_numero[f].ID))
                {
                    ...
                    // CHAN  de la source
                    if (GH.GH.Para.voir_date_changement && info_source.N1_CHAN != null)
                    {
                        liste_note_STRUCTURE_ID_numero =
        ...
        { 
            ...
            bool boucler = false;
            bool modifier = false;
            List<int> liste_numero_lien = new List<int>();
            if (!GH.GH.Para.voir_media || liste_MULTIMEDIA_ID_numero == null) return (
                liste_MULTIMEDIA_ID_numero,
                liste_citation_ID_numero,
                liste_source_ID_numero,
                liste_note_STRUCTURE_ID_numero,
            ...
            foreach( MULTIMEDIA_ID_numero info_MULTIMEDIA_ID_numero in liste_MULTIMEDIA_ID_numero)
            {
                ...
                if (info_MULTIMEDIA_ID_numero.ID_RECORD != null)
                {
                    ...
                    // citation
                    if (GH.GH.Para.voir_reference && info_record != null)
                    {
                        (liste_citation_ID_numero, modifier) =
            ...
            )
        {
            ...
            bool boucler = false;
            bool modifier;
            if (!GH.GH.Para.voir_media) return (
                liste_SUBMITTER_ID_numero,
                liste_MULTIMEDIA_ID_numero,
                liste_citation_ID_numero,
                liste_source_ID_numero,
            ...
            )
        {
            ...
            bool modifier = false;
            bool boucler = false;
            if (!GH.GH.Para.voir_reference || liste_citation_ID_numero.Count == 0)
                return (
                    liste_MULTIMEDIA_ID_numero,
                    liste_citation_ID_numero,
                    liste_source_ID_numero,
        ...
        {
            if (R.IsNullOrEmpty(texte)) return null;
        ...
        private static string Traduire_QUAY(string s)
        {
            switch (s)
            {
                case "0": return "Des preuves ou des données non fiables ont été estimées.";
                case "1": return "Preuve directe ou primaire avec une question de fiabilité ou potentiel de biais, par exemple une autobiographie).";
                case "2": return "Preuve secondaire.";
                case "3": return "Preuve directe et primaire utilisée, ou par dominance de la preuve.";
            }
            return s;
        }
        private static string Traduire_relation_conjoint(string s)
        {
            switch (s.ToLower())
            {
                case "civil": return "Mariage civil";
                case "cohabitation": return " Cohabitation";
                case "common law": return "Mariage de fait en union libre";
                case "extraconjugal_relation": return "Relation extraconjugale";
                case "living apart together": return "Vivre séparément ensemble";
                case "living together": return "Living together";
                case "marriage": return "Marriage";
                case "not married": return "Pas marié";
                case "partnership": return "Partenariat";
                case "registered partnership": return "Partenariat enregistré";
                case "religious": return " Mariage religieux";
        ...
        private static string Convertir_TAG_texte(string s)
        {
            switch (s.ToUpper())
            {
                case "BUYR": return "Acheteur";
                case "BROT": return "Frère";
                case "CHIL": return "Enfant";
                case "FATH": return "Père";
                case "GODP": return "Parrain/maraine";
                case "HDOH": return "Chef de ménage";
                case "HDOG": return "HDOG";
                case "HEIR": return "A hérité ou a le droit d'hériter d'une succession";
                case "HFAT": return "Agissant en tant que père du mari pour l'évènement";
                case "HUSB": return "Conjoint";
                case "HMOT": return "Agissant en tant que mère du mari pour l'évènement";
                case "INFT": return "Rapporté des faits concernant l'évènement";
                case "LEGA": return "Légale";
                case "MEMBER": return "Membre";
                case "MOTH": return "Mère";
                case "OFFICIATOR": return "Officiel";
                case "PARE": return "PARE";
                case "PHUS": return "Conjoint précédent"; // An individual in the role of the principal's previous husband for a cited event.
                case "PWIF": return "Conjointe précédent"; // An individual in the role of the principal's previous wife for a cited event.
                case "RECO": return "Chargée d'enregistrer des informations sur un évènement, un lieu ou une personne.";
                case "REL": return "REL";
                case "ROLE": return "Rôle";
                case "SIBL": return "Enfant"; // A male or female child of a common parent.
                case "SIST": return "Soeur";
                case "SELR": return "Vendeur";
                case "SPOU": return "Conjointe";
                case "TXPY": return "A fait l'objet d'une cotisation";
                case "WFAT": return "Agissant en tant que père de la femme pour l'évènement.";
                case "WIFE": return "Conjointe";
                case "WITN": return "Témoin";
                case "WMOT": return "Agissant en tant que mère de la femme pour l'évènement";
            }
            return s;
        }
        ...
        private static string Traduire_SOURCE_FIDELITY_CODE(string s)
        {
            switch (s.ToUpper())
            {
                ...
                case "PHOTOCOPY": return "Photocopie";
                case "TRANSCRIPT": return "transcription";
                case "EXTRACT": return "Extraction";
            }
            return s;
        }
        private static string Traduire_STATus(string s)
        {
            switch (s.ToUpper())
            {
                case "ACTIVE": return "Actif";
                case "FOUND": return "Trouver";
                case "NO": return "Non";
                case "ORDERED": return "Commender";
                case "PLANNED": return "Planifier";
                case "PROVED": return "Aprouver";
            }
            return s;
        }
        ...
        private static List<ID_numero> Valider_liste_reference_note(
                ...
                List<ID_numero> liste_NOTE_RECORD_ID_numero)
        {
            if (R.IsNullOrEmpty(note_liste_ID)) return liste_NOTE_RECORD_ID_numero;
            if (GH.GH.Para.voir_note)
            {
        ...
        {
            string texte = null;
            if (R.IsNullOrEmpty(nom)) nom = "";
            if (R.IsNullOrEmpty(ID)) ID = "";
            texte = "chercheur_" + nom.Replace(" ", "") + "_" + ID.Replace(" ", "");
            return texte;
        }
        private static string Avoir_nom_lien_evenement(string even, string date)
        {
            string texte = null;
            if (R.IsNullOrEmpty(even)) even = "";
            if (R.IsNullOrEmpty(date)) date = "";
        ...
        {
            //R..Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber + " ID=" + ID);
            if (!GH.GH.Para.voir_note) return null;
            ...
            )
        {
            ...
            if (!GH.GH.Para.voir_note) return null;
            if (R.IsNullOrEmpty(liste_ID)) return null;
            string espace = Tabulation(tab);
            string texte = null;
            foreach (string ID in liste_ID)
            {
                ...
                // note lien
                float temp = 0f;
                if (R.IsNotNullOrEmpty(info_note.N0_texte)) temp = .25f;
        ...
        {
            if (R.IsNullOrEmpty(liste)) return 0;
            int numero = 0;
        ...
        private static int Avoir_numero_reference_MULTIMEDIA(
            string ID,
            List<MULTIMEDIA_ID_numero> liste
            )
        {
            // verifie si ID LINK ou RECORD est dans la liste sinom retourne 0
            if (liste != null) return 0;
            for(int f= 1; f < liste.Count; f++)
            {
                if (liste[f].ID_LINK == ID || liste[f].ID_RECORD == ID)
                {
                    return f;
                }
            }
            ...
            )
        {
            ...
            texte += "\t\t\t\t\t\t<div style=\"width:29px;margin:0 auto\">\n";
            texte += "\t\t\t\t\t\t\t<button style=\"margin-top:2px;\"><a href=\"#haut_page\"><img style=\"height:16px\" src=\"" + origine + "commun/haut_page.svg\" alt=\"\" /></a></button><br />\n";
            texte += "\t\t\t\t\t\t</div>\n";

            texte += "\t\t\t\t\t\t<div style=\"width:87px;margin:0 auto\">\n";
            texte += "\t\t\t\t\t\t\t<button style=\"margin-top:2px;margin-right:27px;\" onclick=\"history.back()\"><img style=\"height:16px\" src=\"" + origine + "commun/page_precedent.svg\" alt=\"\" /></button>\n";
            texte += "\t\t\t\t\t\t\t<button style=\"margin-top:2px;\" onclick=\"history.forward()\"><img style=\"height:16px\" src=\"" + origine + "commun/page_suivant.svg\" alt=\"\" /></button><br />\n";
            texte += "\t\t\t\t\t\t</div>\n";
        ...
        {
            //R..Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            if (R.IsNullOrEmpty(liste_info_nom)) return null;
            string espace = Tabulation(tab);
            string texte = null;
            ...
            foreach (GEDCOMClass.PERSONAL_NAME_STRUCTURE infoNom in liste_info_nom)
            {
                ...
                if (infoNom.N1_PERSONAL_NAME_PIECES != null)
                {
                        ...
                        )
                    {
                        ...
                        if (R.IsNotNullOrEmpty(titre)) titre += " ";
                        string prefix = infoNom.N1_PERSONAL_NAME_PIECES.Nn_SPFX;
                        if (R.IsNotNullOrEmpty(prefix)) prefix += " ";
                        string suffix = infoNom.N1_PERSONAL_NAME_PIECES.Nn_NSFX;
                        if (R.IsNotNullOrEmpty(suffix)) suffix = ", " + suffix;
                ...
                if (infoNom.N1_FONE_name_pieces != null)
                {
                    ...
                    if (R.IsNotNullOrEmpty(prefixFONE)) prefixFONE += " ";
                    suffixFONE = infoNom.N1_FONE_name_pieces.Nn_NSFX;
                    if (R.IsNotNullOrEmpty(suffixFONE)) suffixFONE = ", " + suffixFONE;
                    surnomFONE = infoNom.N1_FONE_name_pieces.Nn_NICK;
                    titreFONE = infoNom.N1_FONE_name_pieces.Nn_NPFX;
                    if (R.IsNotNullOrEmpty(titreFONE)) titreFONE += " ";
                ...
                if (infoNom.N1_ROMN_name_pieces != null)
                {
                    ...
                    if (R.IsNotNullOrEmpty(prefixROMN)) prefixROMN += " ";
                    suffixROMN = infoNom.N1_ROMN_name_pieces.Nn_NSFX;
                    if (R.IsNotNullOrEmpty(suffixROMN)) suffixROMN = ", " + suffixROMN;
                    surnomROMN = infoNom.N1_ROMN_name_pieces.Nn_NICK;
                    titreROMN = infoNom.N1_ROMN_name_pieces.Nn_NPFX;
                    if (R.IsNotNullOrEmpty(titreROMN)) titreROMN += " ";
            ...
            int tab)
        {
            ...
            for (int f = 0; f < liste_NOTE_RECORD_ID_numero.Count; f++)
            {
                ...
                if (info_NOTE_RECORD != null)
                {
                    ...
                    // date de changement
                    if (
                            GH.GH.Para.voir_date_changement &&
                        ...
                        )
                    {
                        ...
                        if (R.IsNotNullOrEmpty(texte_date)) bloc += texte_date.TrimEnd('\r', '\n');
                        bloc += espace + "\t\t</div>\n";
                        bloc += espace + "\t</div>\n";
                    }
                    if (R.IsNotNullOrEmpty(bloc))
                    {
                        ...
                        texte += espace + "\t</div>\n";
                        texte += bloc;
                        texte += Avoir_texte_ligne_perdu(info_NOTE_RECORD.ligne_perdue_liste, tab + 1);
                        // fin tableau
                        texte += espace + "</div>\n";
                    }
                }
        ...
        {
            //GEDCOMClass.ZXXCV("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber + " à <b>" + Avoir_nom_method() + "</b>");
            if (info_place == null) return (null, numero_carte, nombre_source);
            string texte = null;
            string espace = Tabulation(tab);
            // Tableau 0px
            texte += espace + "<div class=\"tableau tableau_0px\">\n";
        ...
        private static string Avoir_texte_lien_repo(
            ...
            int tab)
        {
            if (!GH.GH.Para.voir_reference) return (null);
            if (R.IsNullOrEmpty(ID)) return null;
            string espace = Tabulation(tab);
            ...
            if (numero == 0) return (" Voir dépôt " + BLINK0);
        ...
        {
            GH.GH.erreur = "HT" + sourceLineNumber;
        }
        private static string Avoir_texte_publication(GEDCOMClass.PUBL_record info_PUBL,
            string sous_dossier, int tab = 0)
        {
            if (info_PUBL == null) return null;
            string espace = Tabulation(tab);
            string texte = null;
            // Tableau 0px
            texte += espace + "<div class=\"tableau tableau_0px\">\n";
            ...
            if (R.IsNotNullOrEmpty(info_PUBL.N1_DATE))
            {
                ...
                (string date, _) = Convertir_date(info_PUBL.N1_DATE, GH.GH.Para.date_longue);
                texte += date + "\n";
                texte += espace + "\t\t</div>\n";
                texte += espace + "\t</div>\n";
            }
            ...
            int tab)
        {
            ...
            foreach (GEDCOMClass.CENS_record info_CENS in CENS_liste)
            {
                ...
                {
                    (string date, _) = Convertir_date(info_CENS.N1_DATE, GH.GH.Para.date_longue);
            ...
            )
        {
            ...
            foreach (ID_numero item_REPO in liste_repo_ID_numero)
            {
                ...
                if (info_REPO != null)
                {
                    ...
                    if (R.IsNotNullOrEmpty(info_REPO.N1_REFN_liste))
                    {
                        foreach (GEDCOMClass.USER_REFERENCE_NUMBER info in info_REPO.N1_REFN_liste)
                        {
                            ...
                            bloc += espace + "\t\t<div class=\"tableau_colW\">\n";
                            bloc += "\t\t\t\t\t\t" + info.N0_REFN;
                            if (R.IsNotNullOrEmpty(info.N1_TYPE)) bloc += " Type " + info.N1_TYPE + "\n";
                            else bloc += "\n";
                            bloc += espace + "\t\t</div>\n";
                            bloc += espace + "\t</div>\n";
                        }
                ...
                texte += espace + "\t</div>\n";
                texte += bloc;
                texte += Avoir_texte_ligne_perdu(info_REPO.ligne_perdue_liste, tab + 1);
                texte += espace + "</div>\n";
            }
            GC.Collect();
            return texte;
            ...
            )
        {
            ...
            //R..Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            //foreach (ID_numero item_source in liste_ID_numero) R..Z("N=" + item_source.numero + " ID=" + item_source.ID);
            
            if (liste_ID_numero == null) return null;
            string espace = Tabulation(tab);
            string texte = null;
            int compteurMedia = 0;
            Application.DoEvents();
            foreach (ID_numero item_source in liste_ID_numero)
            {
                compteurMedia++;
                        ...
                        if (info_source != null)
                        {
                            ...
                            if (R.IsNotNullOrEmpty(info_source.N1_TITL_liste))
                            {
                                foreach (string TITL in info_source.N1_TITL_liste)
                                {
                                    ...
                                    if (R.IsNotNullOrEmpty(TITL_id)) texte += Avoir_texte_lien_source(TITL_id, liste_source_ID_numero, 0, 3);
                                    else texte += espace + "\t\t\t\t" + Convertir_texte_html(TITL, false, 0) + "\n";
                                    texte += espace + "\t\t</div>\n";
                                    texte += espace + "\t</div>\n";
                                }
                            }
                            ...
                            if (R.IsNotNullOrEmpty(info_source.N1_PERI))
                            {
                                ...
                                texte += espace + "\t\t</div>\n";
                                texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                                (string date, _) = Convertir_date(info_source.N1_PERI, GH.GH.Para.date_longue);
                                texte += espace + "\t\t\t\t" + date + "\n"; ;
                                texte += espace + "\t\t</div>\n";
                                texte += espace + "\t</div>\n";
                            }
                            // data
                            {
                                ...
                                if (R.IsNotNullOrEmpty(info_source.N3_DATA_EVEN_DATE))
                                {
                                    ...
                                    bloc += espace + "\t\t</div>\n";
                                    bloc += espace + "\t\t<div class=\"tableau_colW\">\n";
                                    (string date_texte, _) = Convertir_date(info_source.N3_DATA_EVEN_DATE, GH.GH.Para.date_longue);
                            ...
                            if (R.IsNotNullOrEmpty(info_source.N1_QUAY))
                            {
                                texte += espace + "\t<div class=\"tableau_ligne\">\n";
                                texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                                texte += espace + "\t\t\t\tCrédibilité: " + Traduire_QUAY(info_source.N1_QUAY) + "\n";
                                texte += espace + "\t\t</div>\n";
                                texte += espace + "\t</div>\n";
                            }
                            // DATE
                            ...
                            {
                                string date = null;
                                (date, _) = Convertir_date(info_source.N1_DATE, GH.GH.Para.date_longue);
                                texte += espace + "\t<div class=\"tableau_ligne\">\n";
                                texte += espace + "\t\t<div class=\"tableau_col1\">\n";
                                texte += espace + "\t\t\t\tDate\n";
                                texte += espace + "\t\t</div>\n";
                            ...
                            {
                                texte += espace + "\t<div class=\"tableau_ligne\">\n";
                                texte += espace + "\t\t<div class=\"tableau_col1\" style=\"width:500px\">\n";
                                texte += espace + "\t\t\t\tCreateur ou compilateur de l'information: \n";
                                texte += espace + "\t\t</div>\n";
                                texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                            ...
                            if (R.IsNotNullOrEmpty(info_source.N1_STAT))
                            {
                                ...
                                {
                                    string date = null;
                                    (date, _) = Convertir_date(info_source.N2_STAT_DATE, GH.GH.Para.date_longue);
                            ...
                            if (R.IsNotNullOrEmpty(info_source.N1_SOUR_EVEN_liste_ID))
                            {
                                texte += espace + "\t<div class=\"tableau_ligne\">\n";
                                texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                            ...
                            // ligne perdue
                            texte += Avoir_texte_ligne_perdu(info_source.ligne_perdue_liste, tab + 1);
                            // fin tableau
                            texte += espace + "</div>\n";
                        }
                    }
                ...
                if (GEDCOMClass.Si_info_event(item_source.ID))
                {
                    ...
                    if (info_event != null)
                    {
                        ...
                        if (R.IsNotNullOrEmpty(info_event.N2_EVEN_PERI))
                        {
                            ...
                            texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                            string date;
                            (date, _) = Convertir_date(info_event.N2_EVEN_PERI, GH.GH.Para.date_longue);
                            texte += espace + "\t\t\t" + date + "\n"; ;
                            texte += espace + "\t\t</div>\n";
                            texte += espace + "\t</div>\n";
                        }
                                ...
                                foreach (GEDCOMClass.ASSOCIATION_STRUCTURE info_ASSO in info_event.N3_EVEN_ROLE_ASSO_liste)
                                {
                                    ...
                                    if (GEDCOMClass.Si_individu(info_ASSO.N0_ASSO))
                                    {
                                        ...
                                        if (R.IsNotNullOrEmpty(info_ASSO.N1_TYPE))
                                        {
                                            ...
                                            {
                                                case "FAM": type = "Famille"; break;
                                                case "INDI": type = "Individu"; break;
                                            }
                                            texte += espace + "\t<div class=\"tableau_ligne\">\n";
                        ...
                        texte +=
                            ...
                            tab + 1);
                        // date de changement
                        if (GH.GH.Para.voir_date_changement && info_event.N1_CHAN != null)
                        {
                        ...
                        texte += Avoir_texte_ligne_perdu(info_event.ligne_perdue_liste, tab + 1);
                        // fin tableau
                        texte += espace + "</div>\n";
                    }
                }
            ...
            )
        {
            ...
            if (R.IsNotNullOrEmpty(info_REPO.N1_CALN))
            {
                ...
                if (R.IsNotNullOrEmpty(info_REPO.N2_CALN_PAGE))
                {
                    texte += espace + "\t<div class=\"tableau_ligne\">\n";
                    texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                    texte += espace + "\t\t\t<span style=\"padding:.25in\">Numéro de feuille: " + info_REPO.N2_CALN_PAGE + "</span>\n";
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                }
                // REFN
                if (R.IsNotNullOrEmpty(info_REPO.N1_REFN))
                {
                    texte += espace + "\t<div class=\"tableau_ligne\">\n";
                    texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                    texte += espace + "\t\t\tRéférence: " + info_REPO.N1_REFN + "\n";
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                }
                if (R.IsNotNullOrEmpty(info_REPO.N1_NOTE_STRUCTURE_liste_ID))
        ...
        private string Bas_Page(string origine)
        {
            string texte = null;
            ...
            texte += "\t\t\t\t<span style=\"padding:5px;\">Généré par GH (GEDCOM-Html) V0.1B, le " + laDate.ToString("dd MMMMM yyyy") + "</span>\n";
            texte += Separation(15, null, "000", null, 4);
            texte += "\t\t\t</footer>\n";
        ...
        {
            //GEDCOMClass.ZXXCV("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            if (!GH.GH.Para.voir_carte) return "";
            string espace = Tabulation(tab);
        ...
        private static int Comparer_annee(string a1, string a2)
        {
            int an1 = 99999999;
            int an2 = 99999999;
            if (a1.All(char.IsDigit)) an1 = int.Parse(a1);
            if (a2.All(char.IsDigit)) an2 = int.Parse(a2);
            ...
            )
        {
            //R..Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            string espace = Tabulation(tab);
            if (R.IsNullOrEmpty(s)) return null;
            ...
            Convertir_date(string date, bool date_long)
        {
            ...
            if (l == 1)
            {
                if (date.All(char.IsDigit)) an = int.Parse(date);
                retourne = date;
            }
            else if (l == 2)
            {
                ...
                if (d[0] == "ABT" || d[0] == "ABT.")
                {
                    if (d[1].All(char.IsDigit)) an = int.Parse(d[1]);
                ...
                {
                    if (d[1].All(char.IsDigit)) an = int.Parse(d[1]);
                    if (date_long) retourne = Convertir_mois_texte(d[0]) + " " + d[1];
                    else retourne = d[1] + "-" + Convertir_mois_chiffre(d[0]);
                }
            }
            else if (l == 3)
            {
                ...
                if (d[0] == "ABT" || d[0] == "ABT.")
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Autour de " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Autour de " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // AFT      DEC     1852
                else if (d[0] == "AFT" || d[0] == "AFT.")
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Après " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Après " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // BEF      DEC     1852
                else if (d[0] == "BEF" || d[0] == "BEF.")
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Avant " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Avant " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // BET      DEC     1852
                ...
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Entre " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Entre " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // CA      DEC     1852
                else if (d[0] == "CA")
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Environ " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Environ " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // CAL      DEC     1852
                else if (d[0] == "CAL" || d[0] == "CAL")
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Calculé " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Calculé " + d[2] + " " + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // EST      DEC     1852
                else if (d[0] == "EST" || d[0] == "EST.")
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Estimé " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Estimé " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // FROM      DEC     1852
                else if (d[0] == "FROM")
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "À partir de " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "À partir de " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // INT      DEC     1852
                else if (d[0] == "INT")
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Interprèter " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Interprèter  " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // 1853     OR      1853
                else if (d[1] == "OR")
                ...
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Dit " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Dit " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // TO       DEC     1852
                else if (d[0] == "TO")
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = "Jusqu'a " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = "Jusqu'a " + d[2] + "-" + Convertir_mois_chiffre(d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // 24       DEC     1852
                else
                {
                    if (d[2].All(char.IsDigit)) an = int.Parse(d[2]);
                    if (date_long) retourne = d[0] + " " + Convertir_mois_texte(d[1]) + " " + d[2];
                    else retourne = d[2] + "-" + Convertir_mois_chiffre(d[1]) + "-" + d[0];
                }
            }
            else if (l == 4)
            {
                ...
                if (d[0] == "ABT" || d[0] == "ABT.")
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Autour de " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Autour de " + d[3] + " " + Convertir_mois_chiffre(d[2]) + "-" + d[1];
                }
                // 0        1       2       3       4       5       6       7  
                // AFT      24      DEC     1852
                else if (d[0] == "AFT" || d[0] == "AFT.")
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Après " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Après " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1];
                }
                // 0        1       2       3       4       5       6       7
                // BEF      24       DEC    1852
                else if (d[0] == "BEF" || d[0] == "BEF.")
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Avant " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Avant " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1];
                }
                // 0        1       2       3       4       5       6       7
                // BET     1852    AND     1853
                ...
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Environ " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Environ " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1];
                }
                // 0        1       2       3       4       5       6       7
                // CAL     24      DEC     1852
                else if (d[0] == "CAL" || d[0] == "CAL.")
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Calculé " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Calculé " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1];
                }
                ...
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Estimé " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Estimé " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1];
                }
                // 0        1       2       3       4       5       6       7
                // FROM     1852    TO      1853
                ...
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Depuis " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Depuis " + d[3] + "-" + Convertir_mois_chiffre(d[2] + "-" + d[1]);
                }
                // 0        1       2       3       4       5       6       7
                // INT      24      DEC     1852
                else if (d[0] == "INT")
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Interprèter " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Interprèter " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + "-" + d[1];
                }
                // 0        1       2       3       4       5       6       7
                // JAN      1853    OR      1854
                else if (d[2] == "OR")
                {
                    an = Comparer_annee(d[1], d[3]);
                    if (date_long) retourne = Convertir_mois_texte(d[0]) + " " + d[1] + " ou " + d[3];
                    else retourne = Convertir_mois_chiffre(d[1]) + " " + d[0] + " ou " + d[3];
                }
                // 0        1       2       3       4       5       6       7
                // 1853     OR      JAN     1853
                else if (d[1] == "OR")
                {
                    ...
                    if (date_long) retourne = d[0] + " ou " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = d[0] + " ou " + d[3] + "-" + Convertir_mois_chiffre(d[2]);
                }
                // 0        1       2       3       4       5       6       7
                // SAY      24      DEC     1852
                else if (d[0] == "SAY")
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Dit " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Dit " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1];
                }
                // 0        1       2       3       4       5       6       7
                // TO       24      DEC     1852
                else if (d[0] == "TO")
                {
                    if (d[3].All(char.IsDigit)) an = int.Parse(d[3]);
                    if (date_long) retourne = "Jusqu'au " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3];
                    else retourne = "Jusqu'au " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1];
                }
            ...
            else if (l == 5)
            {
                ...
                if ((d[0] == "BET" || d[0] == "BET.") && d[2] == "AND")
                {
                    ...
                    if (date_long) retourne = "Entre " + d[1] + " et " + Convertir_mois_texte(d[3] + " " + d[4]);
                    else retourne = "Entre " + d[1] + " et " + d[4] + "-" + Convertir_mois_chiffre(d[3]);
                }
                // 0        1       2       3       4       5       6       7
                ...
                else if ((d[0] == "BET" || d[0] == "BET.") && d[3] == "AND")
                {
                    ...
                    if (date_long) retourne = "Entre " + Convertir_mois_texte(d[1]) + " " + d[2] + " et " + d[4];
                    else retourne = "Entre " + d[2] + "_" + Convertir_mois_chiffre(d[1]) + " et " + d[4]; ;
                }
                // 0        1       2       3       4       5       6       7
                ...
                {
                    an = Comparer_annee(d[1], d[3]);
                    if (date_long) retourne = "De " + d[1] + " à " + Convertir_mois_texte(d[3]) + " " + d[4];
                    else retourne = "De " + d[1] + " à " + d[4] + "-" + Convertir_mois_chiffre(d[3]);
                }
                // 0        1       2       3       4       5       6       7
                ...
                {
                    an = Comparer_annee(d[2], d[4]);
                    if (date_long) retourne = "De " + Convertir_mois_texte(d[1]) + " " + d[2] + " à " + d[4];
                    else retourne = "De " + d[2] + "-" + Convertir_mois_chiffre(d[1]) + " à " + d[4];
                }
                // 0        1       2       3       4       5       6       7
                // 1853     OR      1       JAN     1953 
                else if (d[1] == "OR")
                {
                    ...
                    if (date_long) retourne = d[0] + " ou " + d[2] + " " + Convertir_mois_texte(d[3]) + " " + d[4];
                    else retourne = d[0] + " ou " + d[4] + "-" + Convertir_mois_chiffre(d[3]) + "-" + d[2];
                }
                // 0        1       2       3       4       5       6       7
                ...
                {
                    an = Comparer_annee(d[1], d[4]);
                    if (date_long) retourne = Convertir_mois_texte(d[0]) + " " + d[1] + " ou " + Convertir_mois_texte(d[3]) + " " + d[4];
                    else retourne = d[1] + "-" + Convertir_mois_chiffre(d[0]) + " ou " + d[4] + "-" + Convertir_mois_chiffre(d[3]);
                }
                // 0        1       2       3       4       5       6       7
                // 1        JAN     1853    OR      1854    
                else if (d[3] == "OR")
                {
                    an = Comparer_annee(d[2], d[4]);
                    if (date_long) retourne = d[0] + " " + Convertir_mois_texte(d[1]) + " " + d[2] + " ou " + d[4];
                    else retourne = d[2] + "-" + Convertir_mois_chiffre(d[1]) + "-" + d[0] + " ou " + d[4];
                }
                else GEDCOMClass.DEBUG("Problème pour convertir la date " + date); // ###DEBUG###
            }
            else if (l == 6)
            {
                ...
                if ((d[0] == "BET" || d[0] == "BET.") && d[2] == "AND")
                {
                    ...
                    if (date_long) retourne = "Entre " + d[1] + " et " + d[3] + " " + Convertir_mois_texte(d[4]) + " " + d[5];
                    else retourne = "Entre " + d[1] + " et " + d[5] + "-" + Convertir_mois_chiffre(d[4]) + "-" + d[3];
                }
                // 0        1       2       3       4       5       6       7
                ...
                else if ((d[0] == "BET" || d[0] == "BET.") && d[3] == "AND")
                {
                    ...
                    if (date_long) retourne = Convertir_mois_texte(d[1]) + " " + d[2] + " et " + Convertir_mois_texte(d[4]) + " " + " " + d[5];
                    else retourne = "Entre " + d[2] + "-" + Convertir_mois_chiffre(d[1]) + " et " + d[5] + "-" + Convertir_mois_chiffre(d[4]);
                }
                // 0        1       2       3       4       5       6       7  
                ...
                else if ((d[0] == "BET" || d[0] == "BET.") && d[4] == "AND")
                {
                    ...
                    if (date_long) retourne = "Entre " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3] + " et " + d[5];
                    else retourne = "Entre " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1] + " et " + d[5];
                }
                // 0        1       2       3       4       5       6       7
                ...
                {
                    an = Comparer_annee(d[3], d[5]);
                    if (date_long) retourne = "Du " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + " " + d[3] + " à " + d[5];
                    else retourne = "Du " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[3] + " à " + d[5];
                }
                // 0        1       2       3       4       5       6       7  
                ...
                {
                    an = Comparer_annee(d[2], d[5]);
                    if (date_long) retourne = "De " + Convertir_mois_texte(d[1]) + " " + d[2] + " à " + Convertir_mois_texte(d[4]) + " " + d[5];
                    else retourne = "De " + d[2] + "-" + Convertir_mois_chiffre(d[1]) + " à " + d[5] + "-" + Convertir_mois_chiffre(d[4]);
                }
                // 0        1       2       3       4       5       6       7  
                // FROM     24      DEC     1852    TO      1853    
                else if (d[0] == "FROM" && d[4] == "TO")
                {
                    an = Comparer_annee(d[3], d[5]);
                    if (date_long) retourne = "Du " + Convertir_mois_texte(d[1]) + " " + d[2] + " " + d[3] + " à " + d[5];
                    else retourne = "Du " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[3] + " à " + d[5];
                }
                // 0        1       2       3       4       5       6       7  
                ...
                {
                    an = Comparer_annee(d[1], d[5]);
                    if (date_long) retourne = Convertir_mois_texte(d[0]) + " " + d[1] + " ou " + d[3] + " " + Convertir_mois_texte(d[4]) + " " + d[5];
                    else retourne = d[1] + "-" + Convertir_mois_chiffre(d[1]) + " ou " + d[5] + "-" + Convertir_mois_chiffre(d[4]) + "-" + d[3];
                }
                // 0        1       2       3       4       5       6       7
                ...
                {
                    an = Comparer_annee(d[1], d[5]);
                    if (date_long) retourne = Convertir_mois_texte(d[0]) + " " + d[1] + " ou " + d[1] + " " + Convertir_mois_texte(d[4]) + " " + d[5];
                    else retourne = d[1] + "-" + Convertir_mois_chiffre(d[0]) + " ou " + d[5] + "-" + Convertir_mois_chiffre(d[4]) + "-" + d[3];
                }
                // 0        1       2       3       4       5       6       7
                ...
                {
                    an = Comparer_annee(d[2], d[5]);
                    if (date_long) retourne = d[0] + Convertir_mois_texte(d[1]) + d[2] + " ou " + Convertir_mois_texte(d[4]) + " " + d[5];
                    else retourne = d[2] + "-" + Convertir_mois_chiffre(d[1]) + "-" + d[0] + " ou " + d[5] + "-" + Convertir_mois_chiffre(d[4]);
                }
                else GEDCOMClass.DEBUG("Problème pour convertir la date " + date); // ###DEBUG###
            }
            else if (l == 7)
            {
                ...
                if ((d[0] == "BET" || d[0] == "BET.") && d[3] == "AND")
                {
                    ...
                    if (date_long) retourne = "Entre " + Convertir_mois_texte(d[1]) + d[2] + " et " + d[4] + " " + Convertir_mois_texte(d[5]) + " " + d[6];
                    else retourne = "Entre " + d[2] + "-" + Convertir_mois_chiffre(d[1]) + " et " + d[6] + "-" + Convertir_mois_chiffre(d[5]) + "-" + d[4];
                }
                // 0        1       2       3       4       5       6       7
                ...
                else if ((d[0] == "BET" || d[0] == "BET.") && d[4] == "AND")
                {
                    ...
                    if (date_long) retourne = "Entre " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3] + " et " + Convertir_mois_texte(d[5]) + " " + d[6];
                    else retourne = "Entre " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1] + " et " + d[6] + "-" + Convertir_mois_chiffre(d[5]);
                }
                // 0        1       2       3       4       5       6       7   
                ...
                {
                    an = Comparer_annee(d[2], d[6]);
                    if (date_long) retourne = "De " + Convertir_mois_texte(d[1]) + " " + d[2] + " à " + d[4] + " " + Convertir_mois_texte(d[5]) + " " + d[6];
                    else retourne = "De " + d[2] + "-" + Convertir_mois_chiffre(d[1]) + "-" + d[2] + " à " + d[6] + "-" + Convertir_mois_chiffre(d[5]) + "-" + d[4];
                }
                // 0        1       2       3       4       5       6       7
                ...
                {
                    an = Comparer_annee(d[3], d[6]);
                    if (date_long) retourne = "Du " + d[1] + Convertir_mois_texte(d[2]) + " " + d[3] + " à " + Convertir_mois_texte(d[5]) + " " + d[6];
                    else retourne = "Du " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[3] + " à " + d[6] + "-" + Convertir_mois_chiffre(d[5]);
                }
                // 0        1       2       3       4       5       6       7
                // FROM     DEC     1852    TO      24      DEC     1853    
                else if (d[0] == "FROM" && d[4] == "TO")
                {
                    an = Comparer_annee(d[2], d[6]);
                    if (date_long) retourne = "De " + Convertir_mois_texte(d[1]) + " " + d[2] + " au " + d[4] + Convertir_mois_texte(d[5]) + " " + d[6];
                    else retourne = "De " + d[2] + "-" + Convertir_mois_chiffre(d[1] + " au " + d[6] + "-" + Convertir_date_GEDCOM_chiffre(d[5]) + " " + d[4]);
                }
                // 0        1       2       3       4       5       6       7   
                ...
                {
                    an = Comparer_annee(d[2], d[6]);
                    if (date_long) retourne = "Du " + d[0] + " " + Convertir_mois_texte(d[1]) + " " + d[2] + " au " + d[4] + " " + Convertir_mois_texte(d[5]) + " " + d[6];
                    else retourne = "Du " + d[2] + "- " + Convertir_mois_chiffre(d[1]) + "-" + d[0] + " au " + d[6] + "-" + Convertir_mois_chiffre(d[5]) + "-" + d[4];
                }
                // 0        1       2       3       4       5       6       7
                ...
                {
                    an = Comparer_annee(d[2], d[6]);
                    if (date_long) retourne = d[0] + " " + Convertir_mois_texte(d[1]) + " " + d[2] + " ou " + d[4] + " " + Convertir_mois_texte(d[5]) + " " + d[6];
                    else retourne = d[2] + "-" + Convertir_mois_chiffre(d[1]) + "-" + d[0] + " ou " + d[6] + "-" + Convertir_mois_chiffre(d[5]) + "-" + d[6];
                }
                else GEDCOMClass.DEBUG("Problème pour convertir la date " + date); // ###DEBUG###
            }
            else if (l == 8)
            {
                ...
                if ((d[0] == "BET" || d[0] == "BET.") && d[4] == "AND")
                {
                    ...
                    if (date_long) retourne = "Entre " + d[1] + " " + Convertir_mois_texte(d[2]) + d[3] + " et " + d[5] + " " + Convertir_mois_texte(d[6]) + " " + d[7];
                    else retourne = "Entre " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1] + " et " + d[7] + "-" + Convertir_mois_chiffre(d[6]) + "-" + d[5];
                }
                // 0        1       2       3       4       5       6       7
                ...
                {
                    an = Comparer_annee(d[3], d[7]);
                    if (date_long) retourne = "Du " + d[1] + " " + Convertir_mois_texte(d[2]) + " " + d[3] + " au " + d[5] + " " + Convertir_mois_texte(d[6]) + " " + d[7];
                    else retourne = "Du " + d[3] + "-" + Convertir_mois_chiffre(d[2]) + "-" + d[1] + " au " + d[7] + "-" + Convertir_mois_chiffre(d[6]) + "-" + d[5];
                }
                else GEDCOMClass.DEBUG("Problème pour convertir la date " + date); // ###DEBUG###
            }
            else GEDCOMClass.DEBUG("Problème pour convertir la date " + date); // ###DEBUG###
        ...
        private static string Convertir_filiation(string s)
        {
            switch (s)
            {
                case "LEGITIMATE_CHILD": return "Enfant légitime";
                case "ADULTEROUS_CHILD": return "Enfant adultérin";
                case "RECOGNIZED_CHILD": return "Enfant reconnu";
                case "NATURAL_CHILD": return "Enfant naturel";
                case "CHILD_FOUND": return "Enfant trouvé";
                case "ADOPTED_CHILD": return "Enfant adopté";
                case "STILLBORN_CHILD": return "Mort - Né";
                case "RELATIONSHIP_UNKNOW": return "Non Connue";
            }
            return s;
        }
        ...
        private static string Convertir_statut_marital(string s)
        {
            switch (s)
            {
                case "D": return "Célibataire mais légalement divorcé au moment de l'évènement.";
                case "M": return "Marié au moment de l'évènement.";
                case "S": return "Célibataire, jamais marié au moment de l'évènement.";
                case "W": return "Célibataire en raison du décès d'un conjoint.";
            }
            return s;
        }
        private static string Convertir_ROLE_TAG(string s)
        {
            switch (s)
            {
                ...
                case "HMOT": return "Agissant en tant que mère du mari pour l'évènement";
                case "HUSB": return "Conjoint";
                case "INDI": return "Individu";
                case "INFT": return "Rapporté des faits concernant l'évènement";
                case "LEGA": return "Légale";
                case "MEMBER": return "Membre";
                case "MOTH": return "Mère";
                case "OFFI": return "Officiel";
                case "PARE": return "PARE";
                case "PHUS": return "Conjoint précédent";
                case "PWIF": return "Conjointe précéden";
                case "RECO": return "Enregistreur";
                case "REL": return "Relatif";
                case "ROLE": return "Rôle";
                case "SELR": return "Vendeur";
                case "TXPY": return "A fait l'objet d'une cotisation";
                case "WFAT": return "Agissant en tant que père de la femme pour l'évènement.";
        ...
        private static string Convertir_SEX(string s)
        {
            switch (s)
            {
                ...
                case "X": return "Intersexe";
                case "U": return "Inconnue";
                case "N": return "Pas enregistré";
            }
            return s;
        }
        private static string Convertir_mot_anglais(string s)
        {
            ...
            switch (s.ToLower())
            {
                case "audio": s = "Audio"; break;
                case "active": s = "Active"; break;
                case "book": s = "Livre"; break;
                case "card": s = "Fiche"; break;
                case "census": s = "Recensement"; break;
                case "challenged": s = "Lier cet enfant à cette famille est suspect, mais le lien n’a été ni prouvé ni réfuté."; break;
                case "chil": s = "Enfant"; break;
                case "court": s = "Dossier d'un tribunal pénal ou civil"; break;
                case "church": s = "Record d'église"; break;
                case "disproven": s = "Certains prétendent que cet enfant appartient à cette famille, mais le lien a été réfutée."; break;
                case "electronic": s = "Numérique"; break;
                case "extract": s = "Extrait"; break;
                case "fath": s = "Père"; break;
                case "fiche": s = "Fiche"; break;
                case "film": s = "Film"; break;
                case "found": s = "Trouvé"; break;
                case "history": s = "Compte rendu historique publié"; break;
                case "husb": s = "Conjoint"; break;
                case "interview": s = "Entrevue"; break;
                case "journal": s = "Dossier ou un journal personnel"; break;
                case "land": s = "Enregistrement des propriétés foncières ou des transactions"; break;
                case "letter": s = "Lettre ou autre communication écrite"; break;
                case "magazine": s = "Magazine"; break;
                case "manuscript": s = "Manuscrit"; break;
                case "map": s = "Carte géographique"; break;
                case "military": s = "Record militaire"; break;
                case "moth": s = "Mère"; break;
                case "newspaper": s = "Journal"; break;
                case "no": s = "Nom"; break;
                case "ordered": s = "Commandé"; break;
                case "original": s = "Original"; break;
                case "periodical": s = "Périodique"; break;
                case "personal": s = "Source à partir de la mémoire d'une personne."; break;
                case "photo": s = "Photographie"; break;
                case "photocopy": s = "Photocopie"; break;
                case "planned": s = "Prévu"; break;
                case "proved": s = "Prouvé"; break;
                case "recited": s = "Généalogie récitée"; break;
                case "spou": s = "Conjoint(e)"; break;
                case "tradition": s = "Source par le bouche-à-oreille"; break;
                case "transcript": s = "Transcript"; break;
                case "tombstone": s = "Pierre tombale"; break;
                case "video": s = "Vidéo"; break;
                case "vital": s = "Acte vital créé par une agence gouvernementale"; break;
                case "wife": s = "Conjointe"; break;
            }
            return s;
        }
        ...
        private static string Convertir_EVEN_en_texte(string action, string ligne = null)
        {
            if (R.IsNullOrEmpty(action)) return null;
            char carriage_return = (char)0x0D;
            char newline = (char)0x0A;
            string crnl = carriage_return.ToString() + newline.ToString();
            ...
            switch (section[0])
            {
                case "ADOP": return action.Replace("ADOP", "Adoption");
                case "ANUL": return action.Replace("ANUL", "Annulation de mariage");
                case "BAPL": return action.Replace("BAPL", "Baptême huit ans ou plus SDJ");
                case "BAPM": return action.Replace("BAPM", "Baptême");
                case "BARM": return action.Replace("BARM", "Bar Mitzvah");
                case "BASM": return action.Replace("BASM", "Bat Mitsva");
                case "BIRT": return action.Replace("BIRT", "Naissance");
                case "BLES": return action.Replace("BLES", "Bénédiction");
                case "BURI": return action.Replace("BURI", "Inhumation");
                case "BUYR": return action.Replace("BUYR", "Acheteur");
                case "CAST": return action.Replace("CAST", "Caste ") + ligne;
                case "CENS": return action.Replace("CENS", "Recensement");
                case "CHIL": return action.Replace("CHIL", "Enfant");
                case "CHR": return action.Replace("CHR", "Baptême christianisme");
                case "CHRA": return action.Replace("CHRA", "Baptême adulte");
                case "CONF": return action.Replace("CONF", "Confirmation");
                case "CONL": return action.Replace("CONL", "Confirmation LDS");
                case "CREM": return action.Replace("CREM", "Crémation");
                case "DEAT": return action.Replace("DEAT", "Décès");
                case "DIV": return action.Replace("DIV", "Divorce");
                case "DIVF": return action.Replace("DIVF", "Demande de divorce par épouse");
                case "DSCR": return action.Replace("DSCR", "Description physique");
                case "EDUC": return action.Replace("EDUC", "Éducation ") + ligne;
                case "EMIG": return action.Replace("EMIG", "Immigration");
                case "ENDL": return action.Replace("ENDL", "Dotation");
                case "ENGA": return action.Replace("ENGA", "Fiançailles");
                case "EVEN": return action.Replace("EVEN", "Évènement ") + ligne;
                case "FACT": return action.Replace("FACT", "Fait ") + ligne;
                case "FATH": return action.Replace("FATH", "Père");
                case "FCOM": return action.Replace("FCOM", "Première communion");
                case "GODP": return action.Replace("GODP", "Parrain/Marainne");
                case "GRAD": return action.Replace("GRAD", "Graduation");
                case "HDOH": return action.Replace("HDOH", "Chef de maison");
                case "HDOG": return action.Replace("HDOG", "HDOG");
                case "HEIR": return action.Replace("HEIR", "Héritier");
                case "HFAT": return action.Replace("HFAT", "Père du conjoint");
                case "HMOT": return action.Replace("HMOT", "Mère du conjoint");
                case "HUSB": return action.Replace("HUSB", "Conjoint");
                case "IDNO": return action.Replace("IDNO", "Numéro ID nationnal ") + ligne;
                case "IMMI": return action.Replace("IMMI", "Immigration");
                case "INDI": return action.Replace("INDI", "Individu");
                case "INDO": return action.Replace("INDO", "Numéro d'identification ") + ligne;
                case "INFT": return action.Replace("INFT", "Informateur");
                case "LEGA": return action.Replace("LEGA", "Légataire");
                case "MARB": return action.Replace("MARB", "Publication des bans");
                case "MARC": return action.Replace("MARC", "contrat de mariage");
                case "MARL": return action.Replace("MARL", "Licence de mariage");
                case "MARR": return action.Replace("MARR", "Mariage");
                case "MARS": return action.Replace("MARS", "Contrat de mariage");
                case "MEMBER": return action.Replace("MEMBER", "Membre");
                case "MILI": return action.Replace("MILI", "Militaire");
                case "MOTH": return action.Replace("MOTH", "Mère");
                case "NATI": return action.Replace("NATI", "Nationalité ") + ligne;
                case "NATU": return action.Replace("NATU", "Naturalization");
                case "NCHI": return action.Replace("NCHI", "Nombre d'enfant ") + ligne;
                case "NMR": return action.Replace("NMR", "Nombre de mariage ") + ligne;
                case "OCCU": return action.Replace("OCCU", "Profession ") + ligne;
                case "OFFI": return action.Replace("OFFI", "Officiel");
                case "ORDN": return action.Replace("ORDN", "Ordination");
                case "PARE": return action.Replace("PARE", "PARE");
                case "PHUS": return action.Replace("PHUS", "Conjoint précédent");
                case "PROB": return action.Replace("PROB", "Homologation d'un testament");
                case "PROP": return action.Replace("PROP", "Propriété ") + ligne;
                case "PWIF": return action.Replace("PWIF", "Conjointe précédeant");
                case "RECO": return action.Replace("RECO", "Enregistreur");
                case "REL": return action.Replace("REL", "Relatif");
                case "RELI": return action.Replace("RELI", "Religion ") + ligne;
                case "RESI": return action.Replace("RESI", "Résidence");
                case "RETI": return action.Replace("RETI", "Retraite");
                case "ROLE": return action.Replace("ROLE", "Rôle");
                case "SELR": return action.Replace("SELR", "Vendeur");
                case "SLGC": return action.Replace("SLGC", "Scellement d'un enfant à ses parents SDJ.");
                case "SPOU": return action.Replace("SPOU", "Conjointe");
                case "SSN": return action.Replace("SSN", "Numéro sécurité sociale ") + ligne;
                case "TITL": return action.Replace("TITL", "Titre ") + ligne;
                case "TXPY": return action.Replace("TXPY", "Taxe payer ") + ligne;
                case "WAC": return action.Replace("WAC", "Évènement d'ordonnance SDJ.");
                case "WFAT": return action.Replace("WFAT", "WFTA");
                case "WIFE": return action.Replace("WIFE", "Conjointe");
                case "WILL": return action.Replace("WILL", "Testament");
                case "WITN": return action.Replace("WITN", "Témoin");
                case "WMOT": return action.Replace("WMOT", "Père de la conjointe");
                case "_ELEC": return action.Replace("_ELEC", "Élection");
                case "_MDCL": return action.Replace("_MDCL", "Information médicale");
                case "_MILT": return action.Replace("_MILT", "Service militaire"); // GRAMPS
            }
            return action;
        }
        private static string Convertir_STAT(string stat)
        {
            ...
            switch (stat)
            {
                case "BIC": return "Cette personne est née dans l'alliance, ce qui signifie qu'elle reçoit automatiquement la bénédiction du scellement «enfant à parent».";
                case "CANCELED": return "Annuler et cosidérer invalide";
                case "CHILD": return "Décédé avant l'âge de huit ans, le baptême n'est pas requis.";//BAPL CONL ENDL
                case "COMPLETED": return "Terminer mais la date n'est pas connue.";//BAPL CONL ENDL
                case "DNS": return "Cette ordonnance n'est pas autorisée ou n'est pas soumis au temple.";
                case "DNS/CAN": return "Cette ordonnance n'est pas autorisée, le scellement précédent a été annulé.";
                case "DONE": return "Cette ordonnance est terminée mais la date n'est pas connue.";
                case "EXCLUDED": return "Le patron a exclu que cette ordonnance soit effacée dans cette soumission.";//BAPL CONL ENDL SLGC
                case "INFANT": return "Décédé avant moins d'un an, baptême ou dotation non requis."; // ENDL
                case "PRE-1970": return "L'ordonnance est probablement terminée, une autre ordonnance pour cette personne a été convertie à partir des registres du temple des travaux achevés avant 1970, donc cette ordonnance est supposé complet jusqu'à la conversion de tous les enregistrements."; //BAPL CONL ENDL SLGC
                case "STILLBORN": return "Mort-né, baptême non requis.";//BAPL CONL ENDL SLGC
                case "SUBMITTED": return "Les données pour la demande d'ordonnance étaient insuffisantes."; // ENDL SLGC
                case "UNCLEARED": return "Data for clearing ordinance request was insufficient.";//BAPL CONL ENDLSLGC
        ...
        {
            //R0.Z("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber + "<br />fichier=[" + fichier + "] <br />sous_dossier=[" + sous_dossier + "]<br />dossier_sortie=[" + dossier_sortie + "]");
            {
                if (fichier == null)
                {
                    //R..Z("A Retourne null");
                ...
                if (sous_dossier == "commun") RepertoireDestination = dossier_sortie + @"/commun/";
                if (sous_dossier == "") RepertoireDestination = dossier_sortie + @"/medias/";
                ...
                {
                    if (GH.GH.Para.dossier_media != "")
                    {
                        source = GH.GH.Para.dossier_media + "\\" + fichierSource;
                    }
                }
                if (!File.Exists(RepertoireDestination + fichierDestination))
                {
                    ...
                    if (File.Exists(source) && fichierSource != null)
                    {
                        ...
                        //R..Z("C Retour [" + fichierDestination + "]");
                        return fichierDestination;
                    }
                }
                else
                {
                    //R..Z("D Retourne [" + fichierDestination + "]");
                    return fichierDestination;
                }
            }
            ...
            */
            foreach (ID_numero item_citation in liste_citation_ID_numero)
            {
                ...
                */
                ...
                if (info_citation == null) return null;
                //{
                // Tableau
                texte += Separation(5, null, "000", null, tab);
                texte += espace + "<div class=\"tableau\">\n";
                ...
                if (R.IsNotNullOrEmpty(info_citation.N1_PERI))
                {
                    ...
                    texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                    string date;
                    (date, _) = Convertir_date(info_citation.N1_PERI, GH.GH.Para.date_longue);
                    texte += espace + "\t\t\t" + date + "\n"; ;
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                }
                ...
                if (R.IsNotNullOrEmpty(info_citation.N1_DATE))
                {
                    ...
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                    (string date, _) = Convertir_date(info_citation.N1_DATE, GH.GH.Para.date_longue);
                    texte += espace + "\t\t\t" + date + "\n";
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                }
                ...
                if (R.IsNotNullOrEmpty(info_citation.N2_DATA_DATE))
                {
                    ...
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                    (string date, _) = Convertir_date(info_citation.N2_DATA_DATE, GH.GH.Para.date_longue);
                    texte += date;
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                ...
                if (R.IsNotNullOrEmpty(info_citation.N1_STAT))
                {
                    ...
                    {
                        (string date, _) = Convertir_date(info_citation.N2_STAT_DATE, GH.GH.Para.date_longue);
                        texte += espace + "\t\t\ten date du " + date + "\n";
                    }
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                ...
                texte += Avoir_texte_ligne_perdu(info_citation.ligne_perdue_liste, tab + 1);
                // fin tableau
                texte += espace + "</div>\n";
                //}
            }
        ...
        {
            //GEDCOMClass.ZXXCV("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            if (GH.GH.Para.voir_date_changement == false || info_date == null) return null;
            string texte = null;
            string espace = Tabulation(tab);
            texte += espace + "<span class=\"dateChangement\">\n";
            texte += espace + "\tDernier changement,\n";
            if (multi_ligne) texte += espace + "\t<br/>&emsp;\n";
            (string date, _) = Convertir_date(info_date.N1_CHAN_DATE, GH.GH.Para.date_longue);
            ...
            int para_evenement_an)
        {
            if (GH.GH.Para.tout_evenement)
            {
                para_evenement_date = GH.GH.Para.tout_evenement_date;
                para_evenement_an = GH.GH.Para.tout_evenement_ans;
            }
            if (R.IsNullOrEmpty(date_evenement)) return "<span class=\"inconnu\"></span>" + "\n";
            // année courante
            DateTime maintenant = DateTime.Now;
            int annee_courante = maintenant.Year;
            string date;
            int an;
            (date, an) = Convertir_date(date_evenement, GH.GH.Para.date_longue);
            if (para_evenement_date && annee_courante >= para_evenement_an + an) return date;
            GC.Collect();
        ...
        {
            if (!Directory.Exists(GH.GH.Para.dosssier_HTML))
            {
            ...
            int tab = 0)
        {
            string origine = @"../";
            if (sous_dossier == "") origine = "";
            if (R.IsNullOrEmpty(liste_repo_ID_numero)) return (null, false);
            string espace = Tabulation(tab);
            string texte = null;
            int nombre_repo = 0;
            string bloc_1 = null;
            ...
            if (bloc_1.Length > 0)
            {
                ...
                // titre du groupe
                string titre = "Dépôt";
                if (R.IsNotNullOrEmpty(liste_repo_ID_numero)) titre += "s";
        ...
        private (string, int, int, bool) Groupe_ordonnance(
            ...
            int tab)
        {
            if (R.IsNullOrEmpty(liste)) return (null, numero_carte, numero_source, false);
            if (!GH.GH.Para.tout_evenement)
            {
                if (!GH.GH.Para.religion) return (null, numero_carte, numero_source, false);
            }
            string origine = @"../";
            string texte = null;
            string espace = Tabulation(tab);
            ...
            if (liste.Count > 1)
            {
                ...
                foreach (GEDCOMClass.LDS_INDIVIDUAL_ORDINANCE info_LDS in liste)
                {
                    ...
                    texte += espace + "\t\t\t<td>\n";
                    string date;
                    (date, _) = Convertir_date(info_LDS.N1_DATE, GH.GH.Para.date_longue);
                    texte += espace + "\t\t\t\t\t" + date + "\n";
                    texte += espace + "\t\t\t</td>\n";
                    texte += espace + "\t\t\t<td>\n";
            ...
            foreach (GEDCOMClass.LDS_INDIVIDUAL_ORDINANCE info_LDS in liste)
            {
                ...
                if (R.IsNotNullOrEmpty(info_LDS.N0_EVEN))
                {
                    texte += espace + "\t<div class=\"tableau_ligne\">\n";
                    texte += espace + "\t\t<div class=\"tableau_tete\">\n";
                    string texte_date = ToUpperFirst(Avoir_texte_date_priver(
                        info_LDS.N1_DATE,
                        GH.GH.Priver.religion,
                        GH.GH.Priver.religion_ans));
                    ...
                    texte += espace + "\t\t\t\t" + description + "\n";
                    if (R.IsNotNullOrEmpty(age)) texte += espace + "\t\t\t à l'âge de " + age + "\n";
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                }
                ...
                if (R.IsNotNullOrEmpty(info_LDS.N1_STAT))
                {
                    ...
                    {
                        (string date2, _) = Convertir_date(info_LDS.N2_STAT_DATE, GH.GH.Para.date_longue);
                ...
                texte += Avoir_texte_NOTE_STRUCTURE(
                    ...
                    .04f, // retrait
                    tab + 1);
                texte += Avoir_texte_ligne_perdu(info_LDS.ligne_perdue_liste, tab + 1);
                // fin tableau
                texte += espace + "</div>\n";
            }
            GC.Collect();
            ...
            )
        {
            ...
            Application.DoEvents();
            bool modifier;
            if (R.IsNullOrEmpty(ID_famille)) return;
            ...
            //Généré référence
            {
                ...
                if (GH.GH.Para.voir_media)
                {
                    ...
                    {
                        (liste_MULTIMEDIA_ID_numero, modifier) = Verifier_liste_MULTIMEDIA(info_famille.MULTIMEDIA_LINK_liste_ID, liste_MULTIMEDIA_ID_numero);
                    }
                }
                // groupe evenement
            ...
            if (!menu) nomFichierFamille = @dossier_sortie + "/familles/page.html";
            ...
            texte += espace + "\t\t\t" + ToUpperFirst(Avoir_texte_date_priver(
            ...
            texte += espace + "\t\t\t" + ToUpperFirst(Avoir_texte_date_priver(
                        deces_date_conjoint,
                        GH.GH.Priver.deces_date,
                        GH.GH.Priver.deces_ans));
            texte += espace + "\t\t</td>\n";
            texte += espace + "\t</tr>\n";
            // conjointe
            texte += espace + "\t<tr>\n";
            ...
            if (GH.GH.Priver.religion)
            {
                if (R.IsNotNullOrEmpty(info_famille.N1_SLGS.N1_DATE))
                {
                    ...
                    bloc += espace + "\t\t\t\t<div class=\"tableau_colW\">\n";
                    bloc += espace + "\t\t\t\t\tDate:  ";
                    bloc += espace + "\t\t\t\t\t" + ToUpperFirst(Avoir_texte_date_priver(
                ...
                {
                    string date_SLGS;
                    (date_SLGS, _) = Convertir_date(info_famille.N1_SLGS.N2_STAT_DATE, GH.GH.Para.date_longue);
                    bloc += espace + "\t\t\t<div class=\"tableau_ligne\">\n";
                    bloc += espace + "\t\t\t\t<div class=\"tableau_colW\">\n";
            ...
            // chercheur
            if ((R.IsNotNullOrEmpty(info_famille.N1_SUBM_liste_ID)) && GH.GH.Para.voir_chercheur)
            {
                bloc += espace + "\t<div class=\"tableau_ligne\">\n";
                bloc += espace + "\t\t<div class=\"tableau_colW\">\n";
            ...
            if (R.IsNotNullOrEmpty(bloc))
            {
                ...
                texte += espace + "<div class=\"tableau\">\n";
                texte += bloc;
                texte += Avoir_texte_ligne_perdu(info_famille.ligne_perdue_liste, tab + 1);
                // fin tableau
                texte += espace + "</div>\n";
            }
            // @enfant *****************************************************************************************************
            ...
            if (listIDEnfant.Count() > 0)
            {
                ...
                // titre du groupe
                string titre = "Enfant";
                if (listIDEnfant.Count() > 1) titre += "s";
                // titre du groupe
                texte += Titre_groupe(origine + @"commun/enfant.svg", titre, null, tab);
                texte += Separation(5, null, "000", null, tab);
                texte += espace + "<table class=\"tableau\">\n";
                texte += espace + "\t<thead>\n";
                texte += espace + "\t\t<tr>\n";
            ...
            catch (Exception msg)
            {
                ...
                GEDCOMClass.Voir_message(message, msg.Message, GH.GH.erreur);
            }
            GC.Collect();
        }
        private string Haut_Page(string sous_dossier, bool menu)
        {
            string origine = @"../";
            if (R.IsNullOrEmpty(sous_dossier)) origine = "";
            ...
            )
        {
            ...
            Regler_code_erreur();
            Application.DoEvents();
            string dossier_sortie = GH.GH.dossier_sortie;
            int numero_source = 0;
            int numero_carte = 0;
            string sous_dossier = "";
            string temp_string; 
            ...
            if (info_GEDCOM.N1_DATE != null)
            {
                ...
                texte += espace + "\t\t</div>\n";
                texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                (string date, _) = Convertir_date(info_GEDCOM.N1_DATE, GH.GH.Para.date_longue);
            ...
            if (R.IsNotNullOrEmpty(info_GEDCOM.N1_CHAR))
            {
                ...
                if (R.IsNotNullOrEmpty(info_GEDCOM.N2_CHAR_VERS)) texte += espace + "\t\t\tVersion " + info_GEDCOM.N2_CHAR_VERS + "\n";
                texte += espace + "\t\t</div>\n";
                texte += espace + "\t</div>\n";
            }
            // _GUID Herisis
            ...
            texte += Avoir_texte_NOTE_STRUCTURE(
                ...
                .04f, // retrait
                tab + 1);
            texte += Avoir_texte_ligne_perdu(info_GEDCOM.ligne_perdue_liste, tab + 1);
            // FIN tableau
            texte += espace + "</div>\n";
            // Information d'envoie ****************************************************************************************
            {
                ...
                if (GH.GH.Para.religion && R.IsNotNullOrEmpty(info_SUBMISSION_RECORD.N1_ORDI))
                {
                    bloc += espace + "\t<div class=\"tableau_ligne\">\n";
                    bloc += espace + "\t\t<div class=\"tableau_col1\">\n";
                ...
                // si changement de date
                if (GH.GH.Para.voir_date_changement && info_SUBMISSION_RECORD.N1_CHAN != null)
                {
                    bloc += espace + "\t<div class=\"tableau_ligne\">\n";
                    bloc += espace + "\t\t<div class=\"tableau_colW\">\n";
                    bloc += Avoir_texte_date_Changement(
            ...
            if (info_GEDCOM.N1_SOUR != null)
            {
                ...
                if (
                    ...
                    info_GEDCOM.N3_SOUR_DATA_CORP != null
                    )
                {
                    texte += espace + "\t<div class=\"tableau_ligne\">\n";
                    texte += espace + "\t\t<div class=\"tableau_col1\">\n";
                    ...
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                    if (info_GEDCOM.N2_SOUR_DATA != null) texte += Convertir_texte_html(info_GEDCOM.N2_SOUR_DATA, false, tab + 3) + "<br />\n";
                    (string date, _) = Convertir_date(info_GEDCOM.N3_SOUR_DATA_DATE, GH.GH.Para.date_longue);
                    if (info_GEDCOM.N3_SOUR_DATA_DATE != null) texte += espace + "\t\t\t" + date + "<br />\n";

                    if (info_GEDCOM.N3_SOUR_DATA_CORP != null) texte += Convertir_texte_html(info_GEDCOM.N3_SOUR_DATA_CORP, false, tab + 3) + "\n";
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                }
                ...
                if (alphabette[f])
                {
                    ...
                    for (int ff = 0; ff < lvChoixFamille.Items.Count; ff++)
                    {
                        ...
                        if ((char)(f + 65) == l)
                        {
                            ...
                            texte += "\t\t\t\t\t<td class=\"liste\">\n";
                            texte += "\t\t\t\t\t\t" + ToUpperFirst(Avoir_texte_date_priver(
                                lvChoixFamille.Items[ff].SubItems[5].Text,
                                GH.GH.Priver.mariage_date,
                                GH.GH.Priver.mariage_ans)) + "\n";
                            texte += "\t\t\t\t\t</td>\n";
                            if (GH.GH.Para.voir_ID)
                    ...
                    {
                        GC.Collect();
                        string message = "Ne peut pas écrire le fichier" + dossier_sortie + ".";
                        GEDCOMClass.Voir_message(message, msg.Message, GH.GH.erreur);
                    }
                }
            }
        ...
        public void Index_famille_conjointe(string dossier_sortie)
        {
            ...
            texte += Haut_Page(sous_dossier, true);
            texte += Separation(15, null, "000", null, 3);
        ...
        public void Index_individu(string dossier_sortie)
        {
            ...
            texte += texte_index;
            texte += "\t\t\t<h1 style=\"background-color:" + GH.GH.Para.arriere_plan + "\">\n";
        ...
        public string Fiche_individu(string ID_individu, string dossier_sortie, bool menu // p.25 +2
        //, [CallerLineNumber] int callerLineNumber = 0
        )
        {
            //GEDCOMClass.ZXXCV("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber);
            ...
            // Généré référence
            {
                ...
                // note conjoint
                Application.DoEvents();
                if (GH.GH.Para.voir_note && info_individu.N1_FAMS_liste_Conjoint != null)
                {
            ...
            if (R.IsNullOrEmpty(ID_individu)) return null;
            bool groupe_archive = false;
            ...
            if (!menu) nomFichierIndividu = dossier_sortie + @"\individus\page.html";
            ...
            // groupe Individu
            {
                ...
                if (info_individu.N1_ASSO_liste != null)
                {
                    foreach (GEDCOMClass.ASSOCIATION_STRUCTURE info_ASSO in info_individu.N1_ASSO_liste)
                    {
                        ...
                        if (info_ASSO.N1_TYPE != null)
                        {
                            ...
                            texte += espace + "\t\t</div>\n";
                            texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                            texte += espace + "\t\t\t" + info_ASSO.N1_TYPE + "\n";
                            texte += espace + "\t\t</div>\n";
                            texte += espace + "\t</div>\n";
                        }
                        ...
                        // source association
                        if (info_ASSO.N1_SOUR_citation_liste_ID != null)
                        {
                            texte += espace + "\t<div class=\"tableau_ligne\">\n";
                            texte += espace + "\t\t<div class=\"tableau_col1\">\n";
                            texte += espace + "\t\t\t&nbsp;\n";
                        ...
                        // association note
                        if ((info_ASSO.N1_NOTE_STRUCTURE_liste_ID != null) && info_ASSO.N1_NOTE_STRUCTURE_liste_ID.Any())
                        {
                            texte += espace + "\t<div class=\"tableau_ligne\">\n";
                            texte += espace + "\t\t<div class=\"tableau_col1\">\n";
                            texte += espace + "\t\t\t&nbsp;\n";
                ...
                // RELI Appartenance religieuse
                if (info_individu.N1_NAMR != null && GH.GH.Para.religion)
                {
                    texte += espace + "\t<div class=\"tableau_ligne\">\n";
                    texte += espace + "\t\t<div class=\"tableau_col1\">\n";
                    texte += espace + "\t\t\tReligion \n";
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                    Convertir_texte_html(info_individu.N1_NAMR, false, tab + 3);
                    texte += espace + "\t\t</div>\n";
                    texte += espace + "\t</div>\n";
                }
                // Nom de la religion V5.3
                if (info_individu.N2_NAMR_RELI != null && GH.GH.Para.religion)
                {
                    texte += espace + "\t<div class=\"tableau_ligne\">\n";
                    texte += espace + "\t\t<div class=\"tableau_col1\">\n";
                    texte += espace + "\t\t\t&nbsp;\n";
                ...
                // chercheur
                if (info_individu.N1_SUBM_liste_ID != null && GH.GH.Para.voir_chercheur)
                {
                    texte += espace + "\t<div class=\"tableau_ligne\">\n";
                    texte += espace + "\t\t<div class=\"tableau_colW\">\n";
                ...
                texte += espace + "\t\t</div>\n";
                texte += espace + "\t</div>\n";
                texte += Avoir_texte_ligne_perdu(info_individu.ligne_perdue_liste, tab + 1);
                texte += espace + "</div>\n";
            }
            // FIN groupe Individu
            ...
            // Groupe Conjoint
            {
                if ((info_individu.N1_FAMS_liste_Conjoint != null) && info_individu.N1_FAMS_liste_Conjoint.Any())
                {
                    ...
                    foreach (GEDCOMClass.SPOUSE_TO_FAMILY_LINK infoLienConjoint in info_individu.N1_FAMS_liste_Conjoint)
                    {
                        ...
                        string txtIDFamille;
                        if (GH.GH.Para.voir_ID == true && IDFamilleConjoint != null)
                        {
                        ...
                        if (GH.GH.Para.voir_ID && infoLienConjoint.N0_ID != null)
                        ...
                        if (GH.GH.Para.voir_ID == true && IDConjoint != null)
                        {
                        ...
                        )
                    {
                            ...
                            infoFamille.N1_slgc)
                        {
                            ...
                            if (infoFamille.N1_PEDI != null)
                            {
                                ...
                                {
                                    case "adopted": pedi = "Indique les parents adoptifs."; break;
                                    case "birth": pedi = "Indique les parents biologiques"; break;
                                    case "foster": pedi = "Indique que l'enfant faisait partie d'une famille d'accueil ou d'une famille tutrice."; break;
                                    case "sealing": pedi = "indique que l'enfant a été scellé à des parents autres que les parents biologiques."; break;
                                }
                            ...
                            if (infoFamille.N1_STAT != null)
                            {
                                ...
                                {
                                    case "challenged": stat = "Lier cet enfant à cette famille est suspect, mais le lien n’a été ni prouvé ni réfuté."; break;
                                    case "disproven": stat = "Certains prétendent que cet enfant appartient à cette famille, mais le lien a été réfutée."; break;
                                    case "proven": stat = "Certains prétendent que cet enfant n'appartient pas à cette famille, mais le lien a été prouvé."; break;
                                }
                                texte_bloc += espace + "\t<div class=\"tableau_ligne\">\n";
                                texte_bloc += espace + "\t\t<div class=\"tableau_col1\">\n";
            ...
            int tab = 0)
        {
            ...
            try
            {
                if (R.IsNullOrEmpty(liste_citation_ID_numero)) return ("", false);
                string espace = Tabulation(tab);
                ...
                if (bloc != null)
                {
                    ...
                    if ((liste_citation_ID_numero != null) && liste_citation_ID_numero.Any()) titre += "s";
                    //titre
            ...
            {
                GC.Collect();
                GEDCOMClass.Voir_message("La section Citation sera manquante pour cet infdividu.", msg.Message, GH.GH.erreur);
                GC.Collect();
                return (null, true);
            }
        }
        private (string, bool)
            ...
            int tab = 0)
        {
            if (R.IsNullOrEmpty(liste_NOTE_RECORD_ID_numero)) return (null, false);
            string texte = null;
            string origine = @"../";
            if (sous_dossier == "") origine = "";
            string espace = Tabulation(tab);
            ...
            if (bloc != null)
            {
                ...
                // titre du groupe
                string titre = "Note";
                if ((liste_NOTE_RECORD_ID_numero != null) && liste_NOTE_RECORD_ID_numero.Any()) titre += "s";
            ...
            )
        {
            ...
            if (bloc_1 != null || bloc_2 != null)
            {
                ...
                // titre du groupe
                string titre = "Source";
                if ((liste_source_ID_numero != null) && liste_source_ID_numero.Any()) titre += "s";
            ...
            )
        {
            ...
            R..Z(a);
            // < debug*/
            if (GH.GH.Para.voir_chercheur == false) return (null, false);
            if (R.IsNullOrEmpty(liste_ID)) return (null, false);
            string origine = @"../";
            if (sous_dossier == "") origine = "";
            string espace = Tabulation(tab);
            string texte = null;
        ...
        {
            if (R.IsNullOrEmpty(longString)) return null;
            ...
            )
        {
            ...
            if (R.IsNotNullOrEmpty(couleur)) texte += "color:#" + couleur + ";";
            if (R.IsNotNullOrEmpty(arriere_plan)) texte += "background-color:#" + couleur + ";";
            texte += "height:" + hauteur + "px;\">" + s + "\n";
            texte += espace + "</div>\n";
            return texte;
        }

        private static bool Si_deces(string balise)
        {
            // retourne  true si relier au deces
            switch (balise)
            {
                // retourne  true si cause deces
                case "DEAT": return true; // {DEATH} The event when mortal life terminates.
            }
            return false;
        }
        private static bool Si_divorce(string balise)
        {
            // retourne  true si relier au mariage
            switch (balise)
            {
                // retourne  true si relier au divorce
                case "DIV": return true; //{DIVORCE} An event of dissolving a marriage through civil action.
                case "DIVF": return true; //{DIVORCE_FILED} An event of filing for a divorce by a spouse.

            }
            return false;
        }
        private static bool Si_inhumation(string balise)
        {
            // retourne  true si relier a l'inhumationl
            switch (balise)
            {
                // retourne  true si cause deces
                case "BURI": return true; // {BURIAL} The event of the proper disposing of the mortal
                                          // remains of a deceased person.
            }
            return false;
        }
        private static bool Si_mariage(string balise)
        {
            // retourne  true si relier au mariage
            switch (balise)
            {
                case "ANUL": return true; // {ANNULMENT} An event declaring a marriage void from the
                                          // beginning(never existed).
                case "ENGA": return true; // {ENGAGEMENT} An event of recording or announcing an agreement
                                          // between two people to become married."
                case "MARB": return true; // {MARRIAGE_BANN} An event of an official public notice given
                                          // that two people intend to marry.
                case "MARC": return true; // {MARR_CONTRACT} An event of recording a formal agreement of
                                          // marriage, including the prenuptial agreement in which
                                          // marriage partners reach agreement about the property rights
                                          // of one or both, securing property to their children.
                case "MARL": return true; // {MARR_LICENSE} An event of obtaining a legal license to marry.
                case "MARR": return true; // {MARRIAGE} A legal, common - law, or customary event of
                                          // creating a family unit of a man and a woman as husband and wife.
                case "MARS": return true; // {MARR_SETTLEMENT} An event of creating an agreement between two people
                                          // contemplating marriage, at which time they agree to release or
        ...
        {
            // retourne  true si relier a la naissance
            switch (balise)
            {
                case "BIRT": return true; // {BIRTH } The event of entering into life.
            }
            return false;
        }
        private static bool Si_religion(string balise)
        {
            // retourne  true si relier à la religion
            switch (balise)
            {
                case "BAPL": return true; // {BAPTISM-LDS} The event of baptism performed at age eight or
                                          // later by priesthood authority of The Church of Jesus Christ
                                          // of Latter-day Saints. (See also BAPM.)
                case "BARM": return true; // {BAR_MITZVAH} The ceremonial event held when a Jewish boy
                                          // reaches age 13.
                
                case "BAPM": return true; // {BAPTISM} The event of baptism (not LDS), performed in infancy
                                          // or later. (See also BAPL and CHR.
                case "BASM": return true; // {BAS_MITZVAH} The ceremonial event held when a Jewish girl
                                          // reaches age 12, also known as "Bat Mitzvah".
                case "BLES": return true; // {BLESSING} A religious event of bestowing divine care or
                                          // intercession.
                case "CHR": return true;  // {CHRISTENING} The religious event (not LDS) of baptizing and/or
                                          // naming a child.
                case "CHRA": return true; // {ADULT_CHRISTNG} The religious event (not LDS) of baptizing
                                          // and/or naming an adult person.
                case "CONF": return true; // {CONFIRMATION}The religious event (not LDS) of conferring the
                                          // gift of the Holy Ghost and, among protestants, full church
                                          // membership.
                case "CONL": return true; // {CONFIRMATION_L} The religious event by which a person
                                          // receives membership in The Church of Jesus Christ of Latter-day
                                          // Saints.
                case "ENDL": return true; // {ENDOWMENT} A religious event where an endowment ordinance
                                          // for an individual was performed by priesthood authority
                                          // in an LDS Temple.
                case "NAMR": return true; // {NAME_RELIGIOUS} A name given to an individual to be used in
                                          // association with one's religion."
                case "ORDN": return true; // {ORDINATION} A religious event of receiving authority to act
                                          // in religious matters.
                case "RELI": return true; // {RELIGION} A religious denomination to which a person is
                                          // affiliated or for which a record applies.
                case "SLGC": return true; // {SEALING_CHILD} A religious event pertaining to the sealing of
                                          // a child to his or her parents in an LDS temple ceremony.
                case "SLGS": return true; // {SEALING_SPOUSE} A religious event pertaining to the sealing of
                                            // a husband and wife in an LDS temple ceremony.
            }
            return false;
        }
       

        private static bool Si_testament(string balise)
        {
            // retourne  true si relier au testament
            switch (balise)
            {
                // retourne  true si cause deces
                case "WILL": return true; // {WILL} A legal document treated as an event, by which a person
                                          // disposes of his or her estate, to take effect after death. The
                                          // event date is the date the will was signed while the person was
                                          // alive. (See also PROBate.)
                case "PROB": return true; // {PROBATE} An event of judicial determination of the validity
                                          // of a will.May indicate several related court activities over
                                          // several dates.
            }
            return false;
        }
            ...
            )
        {
            ...
            if (R.IsNullOrEmpty(ID)) return (liste_numero_ID, false);
            bool modifier = false;
            bool trouver = false;
            int numero = 1;
        ...
        {
            //GEDCOMClass.ZXXCV("De la methode <b>" + (new System.Diagnostics.StackTrace()).GetFrame(1).GetMethod().Name + "</b> à la ligne " + callerLineNumber + " à <b>" + Avoir_nom_method() + "</b>");
            if (R.IsNullOrEmpty(liste_ID)) return (liste_numero_ID, false);
            bool modifier = false;
            foreach (string ID in liste_ID)
            {
                bool trouver = false;
        ...
        {
            if (liste_ID == null) return (liste_MULTIMEDIA_ID_numero, false);
            foreach (string ID in liste_ID)
            {
                ...
                if (info_LINK.ID_seul)
                {
                    ...
                    return (liste_MULTIMEDIA_ID_numero, true);
                }
                MULTIMEDIA_ID_numero a = new MULTIMEDIA_ID_numero
                {
